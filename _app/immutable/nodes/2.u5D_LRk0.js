...
</svg>`;var Y1=X('<div class="svg-container svelte-6pjcsf"><!></div>');function V(e,t){l3(t,!0);let n=m(t,"width",3,40),s=m(t,"height",3,40),i=m(t,"color",3,"#666666");const o={0:A1,1:C1,2:I1,3:T1,4:P1,5:N1,6:R1,7:D1,8:q1,9:S1,10:O1,11:H1,12:V1,13:z1,14:U1,15:W1,16:j1,axis_left:K1,axis_right:X1},r={"/":l4,"*":L4,",":g4,".":h4,":":d4,";":Q4,"[":w4,"]":f4,"+":v4,"-":c4,"~":u4," ":p4,'"':F4,backspace:k4,capslock:x4,tab:_4,shift:m4,arrowleft:M4,arrowright:y4,arrowup:b4,arrowdown:E4,pagedown:A4,pageup:C4,end:I4,home:T4,control:P4,enter:N4,a:R4,b:D4,c:q4,d:S4,e:O4,f:H4,g:V4,h:z4,i:U4,j:W4,k:j4,l:K4,m:X4,n:Y4,o:J4,p:Z4,q:G4,r:B4,s:$4,t:t1,u:n1,v:e1,w:s1,x:i1,y:o1,z:r1,0:a1,1:l1,2:L1,3:g1,4:h1,5:d1,6:Q1,7:w1,8:f1,9:v1,f1:c1,f2:u1,f3:p1,f4:F1,f5:k1,f6:x1,f7:_1,f8:m1,f9:M1,f10:y1,f11:b1,f12:E1},Q={0:i4,1:o4,2:r4,3:a4};let g=i3(void 0);switch(t.type,["ps4","ps5"].includes(t.type),t.type){case"keyboard_mouse":let h=t.input.toLowerCase();j(g,r[h],!0);break;case"ps4":j(g,o[t.input],!0);break;case"generic":t.input in Q?j(g,Q[t.input],!0):j(g,o[t.input],!0)}var d=m2(),w=F3(d);{var k=h=>{var l=Y1();let x;var L=q(l);q5(L,()=>R(g).replace("<g>",`<g transform="scale(${Math.min(n()/64,s()/64)})">`).replace('fill="#FFFFFF"',`fill="${i()}"`)),D(l),o3(a=>x=$(l,"",x,a),[()=>({height:`${s()??""}px`,width:`${n()??""}px`})]),z(h,l)};S(w,h=>{R(g)&&h(k)})}z(e,d),L3()}class F{}f(F,"DOWN",0),f(F,"RIGHT",1),f(F,"LEFT",2),f(F,"UP",3),f(F,"BUMPER_LEFT",4),f(F,"BUMPER_RIGHT",5),f(F,"TRIGGER_LEFT",6),f(F,"TRIGGER_RIGHT",7),f(F,"VIEW",8),f(F,"MENU",9),f(F,"AXIS_BUTTON_LEFT",10),f(F,"AXIS_BUTTON_RIGHT",11),f(F,"DPAD_UP",12),f(F,"DPAD_DOWN",13),f(F,"DPAD_LEFT",14),f(F,"DPAD_RIGHT",15),f(F,"HOME",16),f(F,"CROSS",0),f(F,"CIRCLE",1),f(F,"SQUARE",2),f(F,"TRIANGLE",3),f(F,"L1",4),f(F,"R1",5),f(F,"L2",6),f(F,"R2",7),f(F,"SHARE",8),f(F,"OPTIONS",9),f(F,"PS",16),f(F,"A",0),f(F,"B",1),f(F,"X",2),f(F,"Y",3),f(F,"LB",4),f(F,"RB",5),f(F,"TL",6),f(F,"TR",7),f(F,"BACK",8),f(F,"START",9),f(F,"XBOX",16);var J1=(e,t)=>{var n;(n=R(t))==null||n.onpressed(),setTimeout(()=>{var s;(s=R(t))==null||s.onrelease()},50)},Z1=X('<div class="hint-container svelte-j52h91"><div class="hint hint-up svelte-j52h91"><!> <!></div></div>'),G1=X('<div class="button-wrapper svelte-j52h91"><button><!></button> <!></div>');function Y3(e,t){l3(t,!0);let n=m(t,"disabled",3,!1),s=m(t,"onpressed",3,void 0),i=m(t,"onhold",3,void 0),o=m(t,"onrelease",3,void 0),r=m(t,"onpointerout",3,void 0),Q=m(t,"style",3,""),g=m(t,"cssclass",3,"vbutton"),d=m(t,"inputMapping",19,()=>({name:"",gamepad:-1,buttons:[F.DOWN],keys:["e"," "]})),w=m(t,"context",19,()=>["default"]),k=m(t,"requiresFocus",3,!1),h=m(t,"consumePress",3,!1),l=i3(""),x,L=i3(void 0);f3(()=>(j(L,new a(d(),x,k(),s(),i(),o(),h()),!0),y3(w(),R(L)),()=>{R(L)&&b3(w(),R(L))}));class a extends A2{onpressed(){return j(l,"button_clicked "),super.onpressed()}onrelease(){j(l,""),super.onrelease()}}var v=G1(),c=q(v);c.__pointerdown=function(...u){var M,b;(b=(M=R(L))==null?void 0:M.onpressed)==null||b.apply(this,u)},c.__click=[J1,L],c.__pointerup=function(...u){var M,b;(b=(M=R(L))==null?void 0:M.onrelease)==null||b.apply(this,u)},c.__pointerout=function(...u){var M;(M=r())==null||M.apply(this,u)};var p=q(c);T5(p,()=>t.children),D(c),M3(c,u=>x=u,()=>x);var A=E(c,2);{var I=u=>{var M=Z1(),b=q(M),_=q(b);{var y=O=>{V(O,{type:"keyboard_mouse",get input(){return d().keys[0]}})};S(_,O=>{d().keys.length>0&&O(y)})}var U=E(_,2);{var K=O=>{V(O,{type:"generic",get input(){return d().buttons[0]}})};S(U,O=>{d().buttons.length>0&&O(K)})}D(b),D(M),J(2,M,()=>Z),J(1,M,()=>Z),z(u,M)};S(A,u=>{T.showHints&&w().includes(T.context)&&u(I)})}D(v),o3(()=>{$(c,Q()),t2(c,1,R(l)+g(),"svelte-j52h91"),c.disabled=n()}),z(e,v),L3()}N3(["pointerdown","click","pointerup","pointerout"]);function J3(e,t){l3(t,!0);let n=m(t,"disabled",3,!1),s=m(t,"onpressed",3,void 0),i=m(t,"onhold",3,void 0),o=m(t,"onrelease",3,void 0),r=m(t,"inputMapping",19,()=>({name:"Help",gamepad:-1,buttons:[F.VIEW],keys:["h"]})),Q=m(t,"context",19,()=>["default"]);f3(()=>{const g=new A2(r(),void 0,!1,s(),i(),o());return g.disabled=n(),y3(Q(),g),()=>{g&&b3(Q(),g)}}),L3()}class B1 extends R3{constructor(n,s,i,o=!1,r,Q,g,d=!1){super(n,i,o,r,Q,g,d);f(this,"axesDown",-1);f(this,"changeFocus");this.changeFocus=s}onbuttonpressed(n,s){if(this.disabled||!k3(this.input,n))return!1;const i=this.input;return i.buttons.includes(s)?this.onpressed():(i.buttons_next.includes(s)&&this.changeFocus(1),i.buttons_prev.includes(s)&&this.changeFocus(-1),!1)}onkeypressed(n){if(this.disabled)return!1;const s=this.input,i=n.key.toLowerCase();return s.keys.includes(i)?this.onpressed():(s.keys_next.includes(i)&&this.changeFocus(1),s.keys_prev.includes(i)&&this.changeFocus(-1),!1)}onupdate(n){if(this.disabled||!k3(this.input,n))return;const s=this.input;for(const i of s.axes){const o=n.axes[i];let r=s.sensitivity;if(o<-r&&this.axesDown!=i){this.changeFocus(-1),this.axesDown=i;continue}if(o>r&&this.axesDown!=i){this.changeFocus(1),this.axesDown=i;continue}o<r&&o>-r&&(this.axesDown=-1)}}}var $1=X('<div class="hint-container svelte-pm5mnn"><div class="hint">↑ <!> <!></div></div> <div class="hint-center svelte-pm5mnn"><div class="hint-container svelte-pm5mnn"><div class="hint"><!> <!></div></div></div>',1),tt=X("<li> </li>"),nt=X('<div class="hint-container svelte-pm5mnn"><div class="hint">↓ <!> <!></div></div>'),et=X('<div role="button"><!> <ul></ul> <!></div>');function C2(e,t){l3(t,!0);let n=m(t,"onpressed",3,void 0),s=m(t,"disabled",3,!1),i=m(t,"wrap",3,!0),o=m(t,"style",3,""),r=m(t,"cssclass",3,"vlist"),Q=m(t,"selectedIndex",15,0),g=m(t,"focussed",15,0),d=m(t,"inputMapping",19,()=>({name:"List",gamepad:-1,axes:[1],sensitivity:.05,buttons:[F.DOWN],buttons_prev:[F.DPAD_UP],buttons_next:[F.DPAD_DOWN],keys_prev:["arrowup","w"],keys_next:["arrowdown","s"],keys:["enter","r"]})),w=m(t,"context",19,()=>["default"]),k=m(t,"requiresFocus",3,!0);function h(u){let M="item";return M+=Q()===u?" selected":"",g()===u&&(M+=" focussed"),M}function l(u){u>=t.items.length&&(u=i()?0:t.items.length-1),u<0&&(u=i()?t.items.length-1:0),g(u)}function x(){Q(g()),n()&&n()(),s2()}let L;f3(()=>{const u=new B1(d(),M=>{l(g()+M)},L,k(),x);return y3(w(),u),()=>{b3(w(),u)}});var a=et();w3(a,"tabindex",0);var v=q(a);{var c=u=>{var M=$1(),b=F3(M),_=q(b),y=E(q(_));{var U=N=>{V(N,{type:"keyboard_mouse",get input(){return d().keys_prev[0]}})};S(y,N=>{d().keys_prev.length>0&&N(U)})}var K=E(y,2);{var O=N=>{V(N,{type:"generic",get input(){return d().buttons_prev[0]}})};S(K,N=>{d().buttons_prev.length>0&&N(O)})}D(_),D(b);var n3=E(b,2),P=q(n3),W=q(P),G=q(W);{var B=N=>{V(N,{type:"keyboard_mouse",get input(){return d().keys[0]}})};S(G,N=>{d().keys.length>0&&N(B)})}var v3=E(G,2);{var H=N=>{V(N,{type:"generic",get input(){return d().buttons[0]}})};S(v3,N=>{d().buttons.length>0&&N(H)})}D(W),D(P),D(n3),J(2,b,()=>Z),J(1,b,()=>Z),J(2,P,()=>Z),J(1,P,()=>Z),z(u,M)};S(v,u=>{T.showHints&&w().includes(T.context)&&u(c)})}var p=E(v,2);R5(p,21,()=>t.items,P5,(u,M,b)=>{var _=tt();_.__pointerdown=()=>{s()||(g(b),x())};var y=q(_,!0);D(_),o3(U=>{t2(_,1,U,"svelte-pm5mnn"),C3(y,R(M))},[()=>d2(h(b))]),p3("pointerenter",_,()=>{s()||g(b)}),z(u,_)}),D(p);var A=E(p,2);{var I=u=>{var M=nt(),b=q(M),_=E(q(b));{var y=O=>{V(O,{type:"keyboard_mouse",get input(){return d().keys_next[0]}})};S(_,O=>{d().keys_next.length>0&&O(y)})}var U=E(_,2);{var K=O=>{V(O,{type:"generic",get input(){return d().buttons_next[0]}})};S(U,O=>{d().buttons_next.length>0&&O(K)})}D(b),D(M),J(2,M,()=>Z),J(1,M,()=>Z),z(u,M)};S(A,u=>{T.showHints&&w().includes(T.context)&&u(I)})}D(a),M3(a,u=>L=u,()=>L),o3(()=>{t2(a,1,d2(r()),"svelte-pm5mnn"),$(p,o())}),z(e,a),L3()}N3(["pointerdown"]);class st extends R3{constructor(n,s,i,o,r,Q,g,d=!1,w,k,h,l=!1){super(n,g,d,w,k,h,l);f(this,"setValue");f(this,"getValue");f(this,"min");f(this,"max");f(this,"step");this.setValue=s,this.getValue=i,this.min=o,this.max=r,this.step=Q}onbuttonpressed(n,s){if(this.disabled||!k3(this.input,n))return!1;const i=this.input;return i.buttons.includes(s)?super.onbuttonpressed(n,s):(i.buttons_pos.includes(s)&&this.setValue(Math.min(this.max,this.getValue()+this.step)),i.buttons_neg.includes(s)&&this.setValue(Math.max(this.min,this.getValue()-this.step)),!1)}thisKey(n){return this.input.keys.includes(n.key.toLowerCase())||!1}onkeyhold(n){const s=this.input,i=n.key.toLowerCase();if(s.keys.includes(i))return this.onhold();s.keys_pos.includes(i)&&this.setValue(Math.min(this.max,this.getValue()+this.step)),s.keys_neg.includes(i)&&this.setValue(Math.max(this.min,this.getValue()-this.step))}}var it=X('<div class="hint-container hint-left svelte-il5fu"><div class="hint"><!> <!></div></div>'),ot=X('<div class="hint-container hint-right svelte-il5fu"><div class="hint"><!> <!></div></div>'),rt=X('<div class="vslider svelte-il5fu"><!> <input type="range"/> <!></div>');function Z3(e,t){l3(t,!0);let n=m(t,"value",15,50),s=m(t,"onpressed",3,void 0),i=m(t,"min",3,0),o=m(t,"max",3,100),r=m(t,"step",3,10),Q=m(t,"disabled",3,!1),g=m(t,"inputMapping",19,()=>({name:"Slider",gamepad:-1,sensitivity:.05,axes:0,buttons:[F.DOWN],buttons_neg:[F.L1,F.DPAD_LEFT],buttons_pos:[F.R1,F.DPAD_RIGHT],keys_pos:["d"],keys_neg:["a"],keys:["e","enter"],invert:!1})),d=m(t,"context",19,()=>["default"]),w=m(t,"requiresFocus",3,!0),k;function h(){s2(),s()&&s()()}f3(()=>{const p=new st(g(),A=>{n(A)},()=>n(),i(),o(),r(),k,w(),h);return y3(d(),p),()=>{b3(d(),p)}});var l=rt(),x=q(l);{var L=p=>{var A=it(),I=q(A),u=q(I);{var M=y=>{V(y,{type:"keyboard_mouse",get input(){return g().keys_neg[0]}})};S(u,y=>{g().keys_neg.length>0&&y(M)})}var b=E(u,2);{var _=y=>{V(y,{type:"generic",get input(){return g().buttons_neg[0]}})};S(b,y=>{g().buttons_neg.length>0&&y(_)})}D(I),D(A),J(2,A,()=>Z),J(1,A,()=>Z),z(p,A)};S(x,p=>{T.showHints&&d().includes(T.context)&&p(L)})}var a=E(x,2);U5(a),$(a,"",{},{width:"100%;"}),M3(a,p=>k=p,()=>k);var v=E(a,2);{var c=p=>{var A=ot(),I=q(A),u=q(I);{var M=y=>{V(y,{type:"keyboard_mouse",get input(){return g().keys_pos[0]}})};S(u,y=>{g().keys_pos.length>0&&y(M)})}var b=E(u,2);{var _=y=>{V(y,{type:"generic",get input(){return g().buttons_pos[0]}})};S(b,y=>{g().buttons_pos.length>0&&y(_)})}D(I),D(A),J(2,A,()=>Z),J(1,A,()=>Z),z(p,A)};S(v,p=>{T.showHints&&d().includes(T.context)&&p(c)})}D(l),o3(()=>{w3(a,"min",i()),w3(a,"max",o()),w3(a,"step",r()),a.disabled=Q()}),Z5(a,n),z(e,l),L3()}class at extends R3{constructor(n,s,i,o,r,Q=!1){super(n,r,Q);f(this,"xPos",!1);f(this,"xNeg",!1);f(this,"yPos",!1);f(this,"yNeg",!1);f(this,"gamepadActive",!0);f(this,"pos",[0,0]);f(this,"radius");f(this,"calcPos");f(this,"updatePosition");f(this,"activateGamepad",()=>{this.disabled||(this.gamepadActive=!0)});this.radius=s,this.calcPos=i,this.updatePosition=o}onrelease(){let n=this.pos[0],s=this.pos[1];(this.xPos||this.xNeg)&&(n=0),(this.yPos||this.yNeg)&&(s=0),!(n==this.pos[0]&&s==this.pos[1])&&(this.calcPos(n*this.radius,s*this.radius),this.pos=[n,s],this.gamepadActive=!0)}onhold(){let n=this.pos[0],s=this.pos[1];this.xPos?n=1:this.xNeg&&(n=-1),this.yPos?s=1:this.yNeg&&(s=-1),!(n==this.pos[0]&&s==this.pos[1])&&(this.calcPos(n*this.radius,s*this.radius),this.pos=[n,s],this.gamepadActive=!1)}updateKeys(n){const s=this.input,i=n.key.toLowerCase();this.xPos=s.key_x_pos.includes(i),this.xNeg=s.key_x_neg.includes(i),this.yPos=s.key_y_pos.includes(i),this.yNeg=s.key_y_neg.includes(i)}onkeyrelease(n){this.disabled||(this.updateKeys(n),super.onkeyrelease(n))}onkeyhold(n){this.disabled||(this.updateKeys(n),super.onkeyhold(n))}updateButton(n){const s=this.input;this.xPos=s.button_x_pos.includes(n),this.xNeg=s.button_x_neg.includes(n),this.yPos=s.button_y_pos.includes(n),this.yNeg=s.button_y_neg.includes(n)}onbuttonhold(n,s){this.disabled||(this.updateButton(s),super.onbuttonhold(n,s))}onbuttonrelease(n,s){this.disabled||(this.updateButton(s),super.onbuttonrelease(n,s))}onupdate(n){if(this.disabled||!this.gamepadActive||!k3(this.input,n))return;const s=this.input;let i=n.axes[s.axes_x],o=n.axes[s.axes_y];if(s.invert_x&&(i=-i),s.invert_y&&(o=-o),Math.abs(i)<s.deadzoneX&&Math.abs(o)<s.deadzoneY){this.updatePosition(!1,[0,0]);return}this.updatePosition(!0,[i,o])}}var lt=()=>{},Lt=X("<!> <br/>",1),gt=X("<!> <br/>",1),ht=X('<div class="hints_container svelte-1annkz1"><div class="hint svelte-1annkz1"><!></div> <div class="hint hint-up svelte-1annkz1"><!> <!></div> <div class="hint hint-down svelte-1annkz1"><!> <!></div> <div class="hint hint-left svelte-1annkz1"><!> <!></div> <div class="hint hint-right svelte-1annkz1"><!> <!></div></div>'),dt=X('<div id="joystick_area" role="button" class="svelte-1annkz1"><!> <div class="joystick_container svelte-1annkz1"><div class="joystick_back svelte-1annkz1"></div> <div class="joystick_front svelte-1annkz1"></div></div></div>');function Qt(e,t){l3(t,!0);let n=m(t,"disabled",3,!1),s=m(t,"size",3,100),i=m(t,"backgroundWidth",3,200),o=m(t,"backgroundHeight",3,200),r=m(t,"color",3,"rgb(106, 191, 163)"),Q=m(t,"defaultOpacity",3,.5),g=m(t,"activeOpacity",3,.8),d=m(t,"border",3,1),w=m(t,"borderColor",3,"black"),k=m(t,"position",31,()=>P3([0,0])),h=m(t,"style",3,"background-color: rgb(215, 219, 221);"),l=m(t,"inputMapping",19,()=>({name:"Virtual Joystick",gamepad:-1,axes_x:0,axes_y:1,button_x_pos:[F.DPAD_RIGHT],button_x_neg:[F.DPAD_LEFT],button_y_pos:[F.DPAD_DOWN],button_y_neg:[F.DPAD_UP],deadzoneX:.05,deadzoneY:.05,key_x_pos:["d"],key_x_neg:["a"],key_y_pos:["s"],key_y_neg:["w"],invert_x:!1,invert_y:!1})),x=m(t,"context",19,()=>["default"]),L=m(t,"requiresFocus",3,!1);const a=s()/2;let v=!1,c=i3(P3(Q()));function p(H){if(n()||!l().gamepad||!v||!H.target)return;const N=H.target.getBoundingClientRect(),e3=H.x-N.x,t3=H.y-N.y;_&&(_.gamepadActive=!1,A(e3,t3))}function A(H,N){let e3=H-i()/2,t3=N-o()/2;I(e3,t3)}function I(H,N){const e3=B5(H,N),t3=$5(H,N);let D3=n4(e3,a),E3=t4(D3,t3),h3=E3[0]/a,r3=E3[1]/a;if(Math.abs(h3)<l().deadzoneX&&Math.abs(r3)<l().deadzoneY){k([0,0]),j(c,Q());return}h3=Math.abs(h3)<1e-6?0:h3,r3=Math.abs(r3)<1e-6?0:r3,j(c,g()),k([h3,r3])}function u(){v=!1,j(c,Q()),k([0,0])}function M(H,N){j(c,H?g():Q(),!0),k(N)}let b,_;f3(()=>(_=new at(l(),a,I,M,b,L()),y3(x(),_),()=>{_&&b3(x(),_)}));var y=dt();p3("pointerup",T3,u),w3(y,"tabindex",0),y.__keydown=()=>{b.focus()},y.__click=()=>{b.focus()};let U;y.__pointerdown=H=>{n()||(H.stopImmediatePropagation(),v=!0,p(H))},y.__pointerup=()=>{_==null||_.activateGamepad()},y.__pointermove=p,y.__touchstart=[lt],y.__touchend=()=>{_==null||_.activateGamepad()},y.__pointerout=()=>{_==null||_.activateGamepad()};var K=q(y);{var O=H=>{var N=ht();let e3;var t3=q(N),D3=q(t3);{var E3=C=>{V(C,{type:"generic",input:"axis_left"})},h3=C=>{var g3=m2(),x3=F3(g3);{var U2=O3=>{V(O3,{type:"generic",input:"axis_right"})};S(x3,O3=>{[2,3].includes(l().axes_x)&&[2,3].includes(l().axes_y)&&O3(U2)},!0)}z(C,g3)};S(D3,C=>{[0,1].includes(l().axes_x)&&[0,1].includes(l().axes_y)?C(E3):C(h3,!1)})}D(t3);var r3=E(t3,2),i2=q(r3);{var I2=C=>{V(C,{type:"keyboard_mouse",get input(){return l().key_y_neg[0]}})};S(i2,C=>{l().key_y_neg.length>0&&C(I2)})}var T2=E(i2,2);{var P2=C=>{V(C,{type:"generic",get input(){return l().button_y_neg[0]}})};S(T2,C=>{l().button_y_neg.length>0&&C(P2)})}D(r3);var q3=E(r3,2),o2=q(q3);{var N2=C=>{V(C,{type:"keyboard_mouse",get input(){return l().key_y_pos[0]}})};S(o2,C=>{l().key_y_pos.length>0&&C(N2)})}var R2=E(o2,2);{var D2=C=>{V(C,{type:"generic",get input(){return l().button_y_pos[0]}})};S(R2,C=>{l().button_y_pos.length>0&&C(D2)})}D(q3);var S3=E(q3,2),r2=q(S3);{var q2=C=>{var g3=Lt(),x3=F3(g3);V(x3,{type:"keyboard_mouse",get input(){return l().key_x_neg[0]}}),u3(2),z(C,g3)};S(r2,C=>{l().key_x_neg.length>0&&C(q2)})}var S2=E(r2,2);{var O2=C=>{V(C,{type:"generic",get input(){return l().button_x_neg[0]}})};S(S2,C=>{l().button_x_neg.length>0&&C(O2)})}D(S3);var a2=E(S3,2),l2=q(a2);{var H2=C=>{var g3=gt(),x3=F3(g3);V(x3,{type:"keyboard_mouse",get input(){return l().key_x_pos[0]}}),u3(2),z(C,g3)};S(l2,C=>{l().key_x_pos.length>0&&C(H2)})}var V2=E(l2,2);{var z2=C=>{V(C,{type:"generic",get input(){return l().button_x_pos[0]}})};S(V2,C=>{l().button_x_pos.length>0&&C(z2)})}D(a2),D(N),o3(C=>e3=$(N,"",e3,C),[()=>({width:i()+"px",height:o()+"px"})]),J(2,N,()=>Z),J(1,N,()=>Z),z(H,N)};S(K,H=>{T.showHints&&x().includes(T.context)&&H(O)})}var n3=E(K,2);let P;var W=q(n3);let G;var B=E(W,2);let v3;D(n3),D(y),M3(y,H=>b=H,()=>b),o3((H,N,e3,t3)=>{U=$(y,h(),U,H),P=$(n3,"",P,N),G=$(W,"",G,e3),v3=$(B,"",v3,t3)},[()=>({width:i()+"px",height:o()+"px"}),()=>({left:(i()-s())/2+"px",top:(o()-s())/2+"px"}),()=>({width:s()+"px",height:s()+"px",background:r(),opacity:R(c),transition:"none",border:d()>0?d()+"px solid "+w():0}),()=>({left:k()[0]*a+"px",top:k()[1]*a+"px","margin-top":a/2+"px","margin-left":a/2+"px",transition:"opacity 0.2s ease-in-out",width:a+"px",height:a+"px",background:r(),opacity:R(c),border:d()>0?d()+"px solid "+w():0})]),p3("pointerleave",y,()=>{_==null||_.activateGamepad()}),z(e,y),L3()}N3(["keydown","click","pointerdown","pointerup","pointermove","touchstart","touchend","pointerout"]);var wt=(e,t)=>{t(!1)},ft=X('<div id="sidenav" class="sidenav"><button class="closebtn">&times;</button> <!></div>');function vt(e,t){l3(t,!0);const n=["Main","Second","Third","Settings","Fifth"];let s=m(t,"open",15,!1),i=i3(0);function o(){n[R(i)],s(!1)}var r=ft();let Q;var g=q(r);g.__click=[wt,s];var d=E(g,2);{let w=d3(()=>!s());C2(d,{get disabled(){return R(w)},onpressed:o,get items(){return n},wrap:!1,get selectedIndex(){return R(i)},set selectedIndex(k){j(i,k,!0)}})}D(r),o3(w=>Q=$(r,"",Q,w),[()=>({width:s()?"250px":"0"})]),z(e,r),L3()}N3(["click"]);var ct=X('<div class="help-modal svelte-zep3tj"><div class="help-content"><!> or <!> toggle help.</div></div>'),ut=X('<!> <!> <!> <!> <div class="background svelte-zep3tj"><main><!> <!> <!> <br/> <!> <br/>  <!><br/> <!><br/> <!> <!> <!><br/> <br/> <!></main></div>',1);function mt(e,t){l3(t,!0);const n=["banana","orange","apple","strawberry"];let s=i3(0),i=i3(P3([0,0])),o,r=i3(!0),Q=i3(!1),g=i3(!0);f3(()=>{setTimeout(()=>{j(g,!1)},2e3)});var d=ut(),w=F3(d);{let P=d3(()=>({name:"Help",gamepad:-1,buttons:[F.VIEW],keys:["h"]}));J3(w,{context:["default","my_ctx"],onpressed:()=>{T.showHints=!T.showHints},get inputMapping(){return R(P)}})}var k=E(w,2);{let P=d3(()=>({name:"Focus next",gamepad:-1,buttons:[F.TRIGGER_RIGHT],keys:["k"]}));J3(k,{onpressed:()=>{s2()},get inputMapping(){return R(P)}})}var h=E(k,2);{let P=d3(()=>({name:"Focus previous",gamepad:-1,buttons:[F.TRIGGER_LEFT],keys:["i"]}));J3(h,{onpressed:()=>{e4()},get inputMapping(){return R(P)}})}var l=E(h,2);vt(l,{get open(){return R(Q)},set open(P){j(Q,P,!0)}});var x=E(l,2),L=q(x);let a;var v=q(L);{var c=P=>{var W=ct();$(W,"",{},{"pointer-events":"none"});var G=q(W),B=q(G);V(B,{type:"keyboard_mouse",input:"h",color:"#FFFFFF"});var v3=E(B,2);V(v3,{type:"ps4",input:"8",color:"#FFFFFF"}),u3(),D(G),D(W),J(3,W,()=>Z,()=>({duration:300})),z(P,W)};S(v,P=>{R(g)&&P(c)})}var p=E(v,2);{let P=d3(()=>({name:"Main Button",gamepad:-1,buttons:[F.RIGHT],keys:["e"]}));Y3(p,{onrelease:()=>{o&&(o.changeContext("my_ctx"),j(r,!1))},get inputMapping(){return R(P)},children:(W,G)=>{u3();var B=z3("switch to context for button2!");z(W,B)},$$slots:{default:!0}})}var A=E(p,2);{let P=d3(()=>({name:"Second Button",gamepad:-1,buttons:[F.LEFT],keys:["q"]}));Y3(A,{onrelease:()=>{o&&(o.changeContext("default"),j(r,!0))},context:["my_ctx"],get inputMapping(){return R(P)},get disabled(){return R(r)},children:(W,G)=>{u3();var B=z3("switch back to default context!");z(W,B)},$$slots:{default:!0}})}var I=E(A,4);{let P=d3(()=>({name:"side nav",gamepad:-1,buttons:[F.UP],keys:["t"]}));Y3(I,{onrelease:()=>{j(Q,!0)},get inputMapping(){return R(P)},children:(W,G)=>{u3();var B=z3("side nav");z(W,B)},$$slots:{default:!0}})}var u=E(I,4);Z3(u,{});var M=E(u,3);Z3(M,{});var b=E(M,3);Z3(b,{});var _=E(b,2);C2(_,{get items(){return n},get selectedIndex(){return R(s)},set selectedIndex(P){j(s,P,!0)}});var y=E(_),U=E(y);Qt(U,{get position(){return R(i)},set position(P){j(i,P,!0)}});var K=E(U,2),O=E(K,2),n3=E(O);M3(s4(n3,{}),P=>o=P,()=>o),D(L),D(x),o3((P,W,G)=>{a=$(L,"",a,P),C3(y,` Selected: ${n[R(s)]??""} `),C3(K,` x: ${W??""}`),C3(O,` y: ${G??""} `)},[()=>({"margin-left":R(Q)?"250px":0}),()=>R(i)[0].toFixed(3),()=>R(i)[1].toFixed(3)]),z(e,d),L3()}export{mt as component};
