import"../chunks/DsnmJJEf.js";import{a as W2,b as K2,w as p2,l as X2,o as u3,e as v3,s as m3,d as i2}from"../chunks/DO4x5Ptl.js";import{j as F2,b as Y2,g as P3,h as B,aa as _3,d as $3,y,A as j2,r as J2,H as Z2,e as Q2,i as V3,o as L3,ab as k2,af as $2,k as t2,m as t5,l as c3,aB as n5,ax as e5,aC as w2,aj as x2,a8 as s5,aD as i5,n as _2,p as o5,aE as r5,aF as a5,aG as U3,aH as m2,ad as M2,aI as l5,ai as L5,aJ as g5,F as o2,_ as j,aK as d5,ag as h5,ae as Q5,al as u2,aL as w5,aM as u5,aN as f5,aO as c5,aP as v5,aQ as p5,E as F5,aR as k5,aS as x5,q as _5,u as y2,aT as m5,aU as M5,aV as y5,aW as b5,v as E5,aX as x3,aY as A5,t as C5,aZ as I5,B as D3,Y as t3,$ as n3,a_ as N3,C as S,ay as $,c as r2,f as h3,a as D,Z as V,a0 as R,a1 as N,a2 as M,s as T5,a$ as d3,aA as R3,az as g3}from"../chunks/BTBtH8BN.js";import{p as F,i as H,b as w3}from"../chunks/ByhNt_yg.js";function P5(n,t){return t}function N5(n,t,e){for(var s=n.items,i=[],o=t.length,a=0;a<o;a++)l5(t[a].e,i,!0);var d=o>0&&i.length===0&&e!==null;if(d){var l=e.parentNode;L5(l),l.append(e),s.clear(),Z(n,t[0].prev,t[o-1].next)}g5(i,()=>{for(var Q=0;Q<o;Q++){var w=t[Q];d||(s.delete(w.k),Z(n,w.prev,w.next)),m2(w.e,!d)}})}function R5(n,t,e,s,i,o=null){var a=n,d={flags:t,items:new Map,first:null};{var l=n;a=B?P3(_3(l)):l.appendChild(F2())}B&&$3();var Q=null,w=!1,f=new Map,L=j2(()=>{var r=e();return s5(r)?r:r==null?[]:x2(r)}),g,p;function u(){q5(p,g,d,f,a,i,t,s,e),o!==null&&(g.length===0?Q?_2(Q):Q=t2(()=>o(a)):Q!==null&&o5(Q,()=>{Q=null}))}Y2(()=>{p??=o2,g=y(L);var r=g.length;if(w&&r===0)return;w=r===0;let c=!1;if(B){var h=J2(a)===Z2;h!==(r===0)&&(a=Q2(),P3(a),V3(!1),c=!0)}if(B){for(var v=null,k,b=0;b<r;b++){if(L3.nodeType===k2&&L3.data===$2){a=L3,c=!0,V3(!1);break}var x=g[b],m=s(x,b);k=n2(L3,d,v,null,x,m,b,i,t,e),d.items.set(m,k),v=k}r>0&&P3(Q2())}if(B)r===0&&o&&(Q=t2(()=>o(a)));else if(t5()){var P=new Set,E=c3;for(b=0;b<r;b+=1){x=g[b],m=s(x,b);var W=d.items.get(m)??f.get(m);W?b2(W,x,b):(k=n2(null,d,null,null,x,m,b,i,t,e,!0),f.set(m,k)),P.add(m)}for(const[I,K]of d.items)P.has(I)||E.skipped_effects.add(K.e);E.add_callback(u)}else u();c&&V3(!0),y(L)}),B&&(a=L3)}function q5(n,t,e,s,i,o,a,d,l){var Q=t.length,w=e.items,f=e.first,L=f,g,p=null,u=[],r=[],c,h,v,k;for(k=0;k<Q;k+=1){if(c=t[k],h=d(c,k),v=w.get(h),v===void 0){var b=s.get(h);if(b!==void 0){s.delete(h),w.set(h,b);var x=p?p.next:L;Z(e,p,b),Z(e,b,x),W3(b,x,i),p=b}else{var m=L?L.e.nodes_start:i;p=n2(m,e,p,p===null?e.first:p.next,c,h,k,o,a,l)}w.set(h,p),u=[],r=[],L=p.next;continue}if(b2(v,c,k),(v.e.f&U3)!==0&&_2(v.e),v!==L){if(g!==void 0&&g.has(v)){if(u.length<r.length){var P=r[0],E;p=P.prev;var W=u[0],I=u[u.length-1];for(E=0;E<u.length;E+=1)W3(u[E],P,i);for(E=0;E<r.length;E+=1)g.delete(r[E]);Z(e,W.prev,I.next),Z(e,p,W),Z(e,I,P),L=P,p=I,k-=1,u=[],r=[]}else g.delete(v),W3(v,L,i),Z(e,v.prev,v.next),Z(e,v,p===null?e.first:p.next),Z(e,p,v),p=v;continue}for(u=[],r=[];L!==null&&L.k!==h;)(L.e.f&U3)===0&&(g??=new Set).add(L),r.push(L),L=L.next;if(L===null)continue;v=L}u.push(v),p=v,L=v.next}if(L!==null||g!==void 0){for(var K=g===void 0?[]:x2(g);L!==null;)(L.e.f&U3)===0&&K.push(L),L=L.next;var a3=K.length;if(a3>0){var f3=Q===0?i:null;N5(e,K,f3)}}n.first=e.first&&e.first.e,n.last=p&&p.e;for(var o3 of s.values())m2(o3.e);s.clear()}function b2(n,t,e,s){n5(n.v,t),n.i=e}function n2(n,t,e,s,i,o,a,d,l,Q,w){var f=(l&r5)!==0,L=(l&a5)===0,g=f?L?e5(i,!1,!1):w2(i):i,p=(l&i5)===0?a:w2(a),u={i:p,v:g,k:o,a:null,e:null,prev:e,next:s};try{if(n===null){var r=document.createDocumentFragment();r.append(n=F2())}return u.e=t2(()=>d(n,g,p,Q),B),u.e.prev=e&&e.e,u.e.next=s&&s.e,e===null?w||(t.first=u):(e.next=u,e.e.next=u.e),s!==null&&(s.prev=u,s.e.prev=u.e),u}finally{}}function W3(n,t,e){for(var s=n.next?n.next.e.nodes_start:e,i=t?t.e.nodes_start:e,o=n.e.nodes_start;o!==null&&o!==s;){var a=M2(o);i.before(o),o=a}}function Z(n,t,e){t===null?n.first=e:(t.next=e,t.e.next=e&&e.e),e!==null&&(e.prev=t,e.e.prev=t&&t.e)}function D5(n,t,e=!1,s=!1,i=!1){var o=n,a="";j(()=>{var d=o2;if(a===(a=t()??"")){B&&$3();return}if(d.nodes_start!==null&&(d5(d.nodes_start,d.nodes_end),d.nodes_start=d.nodes_end=null),a!==""){if(B){L3.data;for(var l=$3(),Q=l;l!==null&&(l.nodeType!==k2||l.data!=="");)Q=l,l=M2(l);if(l===null)throw h5(),Q5;u2(L3,Q),o=P3(l);return}var w=a+"";e?w=`<svg>${w}</svg>`:s&&(w=`<math>${w}</math>`);var f=w5(w);if((e||s)&&(f=_3(f)),u2(_3(f),f.lastChild),e||s)for(;_3(f);)o.before(_3(f));else o.before(f)}})}function E2(n){var t,e,s="";if(typeof n=="string"||typeof n=="number")s+=n;else if(typeof n=="object")if(Array.isArray(n)){var i=n.length;for(t=0;t<i;t++)n[t]&&(e=E2(n[t]))&&(s&&(s+=" "),s+=e)}else for(e in n)n[e]&&(s&&(s+=" "),s+=e);return s}function S5(){for(var n,t,e=0,s="",i=arguments.length;e<i;e++)(n=arguments[e])&&(t=E2(n))&&(s&&(s+=" "),s+=t);return s}function S3(n){return typeof n=="object"?S5(n):n??""}function O5(n,t,e){var s=n==null?"":""+n;return t&&(s=s?s+" "+t:t),s===""?null:s}function f2(n,t=!1){var e=t?" !important;":";",s="";for(var i in n){var o=n[i];o!=null&&o!==""&&(s+=" "+i+": "+o+e)}return s}function K3(n){return n[0]!=="-"||n[1]!=="-"?n.toLowerCase():n}function H5(n,t){if(t){var e="",s,i;if(Array.isArray(t)?(s=t[0],i=t[1]):s=t,n){n=String(n).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var o=!1,a=0,d=!1,l=[];s&&l.push(...Object.keys(s).map(K3)),i&&l.push(...Object.keys(i).map(K3));var Q=0,w=-1;const u=n.length;for(var f=0;f<u;f++){var L=n[f];if(d?L==="/"&&n[f-1]==="*"&&(d=!1):o?o===L&&(o=!1):L==="/"&&n[f+1]==="*"?d=!0:L==='"'||L==="'"?o=L:L==="("?a++:L===")"&&a--,!d&&o===!1&&a===0){if(L===":"&&w===-1)w=f;else if(L===";"||f===u-1){if(w!==-1){var g=K3(n.substring(Q,w).trim());if(!l.includes(g)){L!==";"&&f++;var p=n.substring(Q,f).trim();e+=" "+p+";"}}Q=f+1,w=-1}}}}return s&&(e+=f2(s)),i&&(e+=f2(i,!0)),e=e.trim(),e===""?null:e}return n==null?null:String(n)}function M3(n,t,e,s,i,o){var a=n.__className;if(B||a!==e||a===void 0){var d=O5(e,s);(!B||d!==n.getAttribute("class"))&&(d==null?n.removeAttribute("class"):n.className=d),n.__className=e}return o}function X3(n,t={},e,s){for(var i in e){var o=e[i];t[i]!==o&&(e[i]==null?n.style.removeProperty(i):n.style.setProperty(i,o,s))}}function U(n,t,e,s){var i=n.__style;if(B||i!==t){var o=H5(t,s);(!B||o!==n.getAttribute("style"))&&(o==null?n.removeAttribute("style"):n.style.cssText=o),n.__style=t}else s&&(Array.isArray(s)?(X3(n,e?.[0],s[0]),X3(n,e?.[1],s[1],"important")):X3(n,e,s));return s}const G5=Symbol("is custom element"),B5=Symbol("is html");function z5(n){if(B){var t=!1,e=()=>{if(!t){if(t=!0,n.hasAttribute("value")){var s=n.value;Q3(n,"value",null),n.value=s}if(n.hasAttribute("checked")){var i=n.checked;Q3(n,"checked",null),n.checked=i}}};n.__on_r=e,v5(e),W2()}}function Q3(n,t,e,s){var i=V5(n);B&&(i[t]=n.getAttribute(t),t==="src"||t==="srcset"||t==="href"&&n.nodeName==="LINK")||i[t]!==(i[t]=e)&&(t==="loading"&&(n[p5]=e),e==null?n.removeAttribute(t):typeof e!="string"&&U5(n).includes(t)?n[t]=e:n.setAttribute(t,e))}function V5(n){return n.__attributes??={[G5]:n.nodeName.includes("-"),[B5]:n.namespaceURI===u5}}var c2=new Map;function U5(n){var t=c2.get(n.nodeName);if(t)return t;c2.set(n.nodeName,t=[]);for(var e,s=n,i=Element.prototype;i!==s;){e=c5(s);for(var o in e)e[o].set&&t.push(o);s=f5(s)}return t}const W5=()=>performance.now(),i3={tick:n=>requestAnimationFrame(n),now:()=>W5(),tasks:new Set};function A2(){const n=i3.now();i3.tasks.forEach(t=>{t.c(n)||(i3.tasks.delete(t),t.f())}),i3.tasks.size!==0&&i3.tick(A2)}function K5(n){let t;return i3.tasks.size===0&&i3.tick(A2),{promise:new Promise(e=>{i3.tasks.add(t={c:n,f:e})}),abort(){i3.tasks.delete(t)}}}function T3(n,t){p2(()=>{n.dispatchEvent(new CustomEvent(t))})}function X5(n){if(n==="float")return"cssFloat";if(n==="offset")return"cssOffset";if(n.startsWith("--"))return n;const t=n.split("-");return t.length===1?t[0]:t[0]+t.slice(1).map(e=>e[0].toUpperCase()+e.slice(1)).join("")}function v2(n){const t={},e=n.split(";");for(const s of e){const[i,o]=s.split(":");if(!i||o===void 0)break;const a=X5(i.trim());t[a]=o.trim()}return t}const Y5=n=>n;function y3(n,t,e,s){var i=(n&M5)!==0,o=(n&y5)!==0,a=i&&o,d=(n&m5)!==0,l=a?"both":i?"in":"out",Q,w=t.inert,f=t.style.overflow,L,g;function p(){return p2(()=>Q??=e()(t,s?.()??{},{direction:l}))}var u={is_global:d,in(){if(t.inert=w,!i){g?.abort(),g?.reset?.();return}o||L?.abort(),T3(t,"introstart"),L=e2(t,p(),g,1,()=>{T3(t,"introend"),L?.abort(),L=Q=void 0,t.style.overflow=f})},out(v){if(!o){v?.(),Q=void 0;return}t.inert=!0,T3(t,"outrostart"),g=e2(t,p(),L,0,()=>{T3(t,"outroend"),v?.()})},stop:()=>{L?.abort(),g?.abort()}},r=o2;if((r.transitions??=[]).push(u),i&&K2){var c=d;if(!c){for(var h=r.parent;h&&(h.f&F5)!==0;)for(;(h=h.parent)&&(h.f&k5)===0;);c=!h||(h.f&x5)!==0}c&&_5(()=>{y2(()=>u.in())})}}function e2(n,t,e,s,i){var o=s===1;if(b5(t)){var a,d=!1;return E5(()=>{if(!d){var r=t({direction:o?"in":"out"});a=e2(n,r,e,s,i)}}),{abort:()=>{d=!0,a?.abort()},deactivate:()=>a.deactivate(),reset:()=>a.reset(),t:()=>a.t()}}if(e?.deactivate(),!t?.duration)return i(),{abort:x3,deactivate:x3,reset:x3,t:()=>s};const{delay:l=0,css:Q,tick:w,easing:f=Y5}=t;var L=[];if(o&&e===void 0&&(w&&w(0,1),Q)){var g=v2(Q(0,1));L.push(g,g)}var p=()=>1-s,u=n.animate(L,{duration:l,fill:"forwards"});return u.onfinish=()=>{u.cancel();var r=e?.t()??1-s;e?.abort();var c=s-r,h=t.duration*Math.abs(c),v=[];if(h>0){var k=!1;if(Q)for(var b=Math.ceil(h/16.666666666666668),x=0;x<=b;x+=1){var m=r+c*f(x/b),P=v2(Q(m,1-m));v.push(P),k||=P.overflow==="hidden"}k&&(n.style.overflow="hidden"),p=()=>{var E=u.currentTime;return r+c*f(E/h)},w&&K5(()=>{if(u.playState!=="running")return!1;var E=p();return w(E,1-E),!0})}u=n.animate(v,{duration:h,fill:"forwards"}),u.onfinish=()=>{p=()=>s,w?.(s,1-s),i()}},{abort:()=>{u&&(u.cancel(),u.effect=null,u.onfinish=x3)},deactivate:()=>{i=x3},reset:()=>{s===0&&w?.(1,0)},t:()=>p()}}function j5(n,t,e=t){var s=A5(),i=new WeakSet;X2(n,"input",o=>{var a=o?n.defaultValue:n.value;if(a=Y3(n)?j3(a):a,e(a),c3!==null&&i.add(c3),s&&a!==(a=t())){var d=n.selectionStart,l=n.selectionEnd;n.value=a??"",l!==null&&(n.selectionStart=d,n.selectionEnd=Math.min(l,n.value.length))}}),(B&&n.defaultValue!==n.value||y2(t)==null&&n.value)&&(e(Y3(n)?j3(n.value):n.value),c3!==null&&i.add(c3)),C5(()=>{var o=t();if(n===document.activeElement){var a=I5??c3;if(i.has(a))return}Y3(n)&&o===j3(n.value)||n.type==="date"&&!o&&!n.value||o!==n.value&&(n.value=o??"")})}function Y3(n){var t=n.type;return t==="number"||t==="range"}function j3(n){return n===""?null:+n}const J5=n=>n;function b3(n,{delay:t=0,duration:e=400,easing:s=J5}={}){const i=+getComputedStyle(n).opacity;return{delay:t,duration:e,easing:s,css:o=>`opacity: ${o*i}`}}const Z5=(n,t)=>Math.sqrt(n**2+t**2),$5=(n,t)=>Math.atan2(t,n),t4=(n,t)=>[n*Math.cos(t),n*Math.sin(t)],n4=(n,t)=>Math.min(Math.max(-t,n),t);function F3(n,t){return n.gamepad===-1||n.gamepad===t.index}function C2(n){const t=document.activeElement,e=Array.from(document.querySelectorAll('input, select, textarea, button, [tabindex]:not([tabindex="-1"])'));if(!t)return;let s=e.indexOf(t);for(let i=1;i<e.length;i++){let o=(s+i*n)%e.length;o<0&&(o=e.length-1,s=o);const a=e[o];if(!a.hasAttribute("disabled"))return a}}function e4(){const n=C2(-1);n&&n.focus()}function a2(){const n=C2(1);n&&n.focus()}class O3{focusElement;requiresFocus;input;disabled=!1;onpressedCallback;onholdCallback;onreleaseCallback;consumePress;constructor(t,e,s=!1,i,o,a,d=!1){this.onpressedCallback=i,this.onholdCallback=o,this.onreleaseCallback=a,this.focusElement=e,this.input=t,this.requiresFocus=s,this.consumePress=d}onpressed(){return this.disabled?!1:(this.onpressedCallback&&this.onpressedCallback(),this.consumePress)}onhold(){this.onholdCallback&&this.onholdCallback()}onrelease(){this.onreleaseCallback&&this.onreleaseCallback()}thisGamepadButton(t,e){return F3(this.input,t)}onbuttonpressed(t,e){return this.onpressed()}onbuttonrelease(t,e){this.onrelease()}onbuttonhold(t,e){this.onhold()}onupdate(t){}thisKey(t){return!1}onkeypressed(t){return this.thisKey(t)&&this.onpressed()}onkeyrelease(t){this.thisKey(t)&&this.onrelease()}onkeyhold(t){this.thisKey(t)&&this.onhold()}}const A=D3({components:{},activeComponents:[],showHints:!1,context:"default"}),s2=n=>{A.activeComponents.includes(n)||A.activeComponents.push(n)},E3=(n,t)=>{n.forEach(e=>{A.components[e]||(A.components[e]=[]),A.components[e].push(t)}),!t.requiresFocus&&n.includes("default")&&s2(t),t.focusElement&&t.requiresFocus&&(t.focusElement.addEventListener("focus",()=>{n.includes(A.context)&&s2(t)}),t.focusElement.addEventListener("blur",()=>{A.activeComponents.splice(A.activeComponents.indexOf(t),1)}))},A3=(n,t)=>{n.forEach(e=>{A.components[e]&&A.components[e].splice(A.components[e].indexOf(t),1)}),A.activeComponents.includes(t)&&A.activeComponents.slice(A.activeComponents.indexOf(t))};function s4(n,t){t3(t,!0);let e=F(t,"updateUsingAnimationFrame",3,!1),s=F(t,"updateUsingInterval",3,!0),i=F(t,"timeout",3,1e3/25),o=!0;const a=r=>{A.activeComponents.forEach(h=>{h.focusElement&&h.focusElement.blur()}),A.activeComponents=[],A.components[r].forEach(h=>{(!h.requiresFocus||h.focusElement===document.activeElement)&&s2(h)}),A.context=r};let d={},l={},Q;const w=r=>{Q=r.target.navigator},f=()=>{let r=A.activeComponents;if(Q){for(let c of Q.getGamepads())if(c){for(let h=0;h<c.buttons.length;h++){if(c.buttons[h].pressed&&(r.forEach(v=>{v.thisGamepadButton(c,h)&&v.onbuttonhold(c,h)}),!d[h])){d[h]=!0;for(let v of r)if(v.thisGamepadButton(c,h)&&v.onbuttonpressed(c,h)===!0)break}d[h]&&!c.buttons[h].pressed&&(d[h]=!1,r.forEach(v=>{v.thisGamepadButton(c,h)&&v.onbuttonrelease(c,h)}))}r.forEach(h=>{F3(h.input,c)&&h.onupdate(c)})}}},L=()=>{f(),o&&requestAnimationFrame(L)};u3(()=>{let r;return e()?(o=!0,L()):s()&&(r=setInterval(f,i())),()=>{r&&clearInterval(r),o=!1}});const g=r=>{let c=A.activeComponents;for(let h of c)if(h.onkeypressed(r)===!0)break},p=r=>{const c=r.key.toLowerCase();l[c]||g(r);let h=A.activeComponents;l[c]=!0,h.forEach(v=>{v.onkeyhold(r)})},u=r=>{const c=r.key.toLowerCase();delete l[c],A.activeComponents.forEach(v=>{v.onkeyrelease(r)})};return v3("gamepadconnected",N3,w),v3("keydown",N3,p),v3("keyup",N3,u),n3({changeContext:a})}class q{static DOWN=0;static RIGHT=1;static LEFT=2;static UP=3;static BUMPER_LEFT=4;static BUMPER_RIGHT=5;static TRIGGER_LEFT=6;static TRIGGER_RIGHT=7;static VIEW=8;static MENU=9;static AXIS_BUTTON_LEFT=10;static AXIS_BUTTON_RIGHT=11;static DPAD_UP=12;static DPAD_DOWN=13;static DPAD_LEFT=14;static DPAD_RIGHT=15;static HOME=16;static CROSS=0;static CIRCLE=1;static SQUARE=2;static TRIANGLE=3;static L1=4;static R1=5;static L2=6;static R2=7;static SHARE=8;static OPTIONS=9;static PS=16;static A=0;static B=1;static X=2;static Y=3;static LB=4;static RB=5;static TL=6;static TR=7;static BACK=8;static START=9;static XBOX=16}const i4=`<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs/>
  <g>
    <path
         stroke="none"
...
</svg>`;var X1=V('<div class="svg-container svelte-6pjcsf"><!></div>');function z(n,t){t3(t,!0);let e=F(t,"width",3,40),s=F(t,"height",3,40),i=F(t,"color",3,"#666666");const o={0:A1,1:C1,2:I1,3:T1,4:P1,5:N1,6:R1,7:q1,8:D1,9:S1,10:O1,11:H1,12:G1,13:B1,14:z1,15:V1,16:U1,axis_left:W1,axis_right:K1},a={"/":l4,"*":L4,",":g4,".":d4,":":h4,";":Q4,"[":w4,"]":u4,"+":f4,"-":c4,"~":v4," ":p4,'"':F4,backspace:k4,capslock:x4,tab:_4,shift:m4,arrowleft:M4,arrowright:y4,arrowup:b4,arrowdown:E4,pagedown:A4,pageup:C4,end:I4,home:T4,control:P4,enter:N4,a:R4,b:q4,c:D4,d:S4,e:O4,f:H4,g:G4,h:B4,i:z4,j:V4,k:U4,l:W4,m:K4,n:X4,o:Y4,p:j4,q:J4,r:Z4,s:$4,t:t1,u:n1,v:e1,w:s1,x:i1,y:o1,z:r1,0:a1,1:l1,2:L1,3:g1,4:d1,5:h1,6:Q1,7:w1,8:u1,9:f1,f1:c1,f2:v1,f3:p1,f4:F1,f5:k1,f6:x1,f7:_1,f8:m1,f9:M1,f10:y1,f11:b1,f12:E1},d={0:i4,1:o4,2:r4,3:a4};let l=$(void 0);switch(t.type,["ps4","ps5"].includes(t.type),t.type){case"keyboard_mouse":let L=t.input.toLowerCase();S(l,a[L],!0);break;case"ps4":S(l,o[t.input],!0);break;case"generic":t.input in d?S(l,d[t.input],!0):S(l,o[t.input],!0)}var Q=r2(),w=h3(Q);{var f=L=>{var g=X1();let p;var u=R(g);D5(u,()=>y(l).replace("<g>",`<g transform="scale(${Math.min(e()/64,s()/64)})">`).replace('fill="#FFFFFF"',`fill="${i()}"`)),N(g),j(r=>p=U(g,"",p,r),[()=>({height:`${s()??""}px`,width:`${e()??""}px`})]),D(L,g)};H(w,L=>{y(l)&&L(f)})}D(n,Q),n3()}var Y1=V('<div><div class="hint"> <!> <!></div></div>');function p3(n,t){t3(t,!0);let e=F(t,"context",19,()=>["default"]),s=F(t,"text",3,""),i=F(t,"class",3,"hint-container"),o=F(t,"style",3,"");var a=r2(),d=h3(a);{var l=Q=>{var w=Y1(),f=R(w),L=R(f),g=M(L);{var p=c=>{z(c,{type:"keyboard_mouse",get input(){return t.keys[0]}})};H(g,c=>{t.keys.length>0&&c(p)})}var u=M(g,2);{var r=c=>{z(c,{type:"generic",get input(){return t.buttons[0]}})};H(u,c=>{t.buttons.length>0&&c(r)})}N(f),N(w),j(()=>{M3(w,1,S3(i())),U(w,o()),m3(L,`${s()??""} `)}),y3(2,w,()=>b3),y3(1,w,()=>b3),D(Q,w)};H(d,Q=>{A.showHints&&e().includes(A.context)&&Q(l)})}D(n,a),n3()}class I2 extends O3{thisGamepadButton(t,e){return super.thisGamepadButton(t,e)&&this.input.buttons.includes(e)}thisKey(t){return this.input.keys.includes(t.key.toLowerCase())||!1}}var j1=(n,t)=>{y(t)?.onpressed(),setTimeout(()=>{y(t)?.onrelease()},50)},J1=V("<div><button><!></button> <!></div>");function q3(n,t){t3(t,!0);let e=F(t,"disabled",3,!1),s=F(t,"onpressed",3,void 0),i=F(t,"onhold",3,void 0),o=F(t,"onrelease",3,void 0),a=F(t,"onpointerout",3,void 0),d=F(t,"style",3,""),l=F(t,"cssclass",3,"vbutton"),Q=F(t,"cssclassWrapper",3,"button-wrapper"),w=F(t,"inputMapping",19,()=>({name:"",gamepad:-1,buttons:[q.DOWN],keys:["e"," "]})),f=F(t,"context",19,()=>["default"]),L=F(t,"requiresFocus",3,!1),g=F(t,"consumePress",3,!1),p=$(""),u,r=$(void 0);function c(){return u}u3(()=>(S(r,new h(w(),u,L(),s(),i(),o(),g()),!0),E3(f(),y(r)),()=>{y(r)&&A3(f(),y(r))}));class h extends I2{onpressed(){return S(p,"button_clicked "),super.onpressed()}onrelease(){S(p,""),super.onrelease()}}var v=J1(),k=R(v);k.__pointerdown=function(...m){y(r)?.onpressed?.apply(this,m)},k.__click=[j1,r],k.__pointerup=function(...m){y(r)?.onrelease?.apply(this,m)},k.__pointerout=function(...m){a()?.apply(this,m)};var b=R(k);T5(b,()=>t.children),N(k),w3(k,m=>u=m,()=>u);var x=M(k,2);return p3(x,{get context(){return f()},get keys(){return w().keys},get buttons(){return w().buttons},style:"left: 50%;"}),N(v),j(()=>{M3(v,1,S3(Q()),"svelte-bpza0d"),U(k,d()),M3(k,1,y(p)+l(),"svelte-bpza0d"),k.disabled=e()}),D(n,v),n3({getElement:c})}i2(["pointerdown","click","pointerup","pointerout"]);function J3(n,t){t3(t,!0);let e=F(t,"disabled",3,!1),s=F(t,"onpressed",3,void 0),i=F(t,"onhold",3,void 0),o=F(t,"onrelease",3,void 0),a=F(t,"inputMapping",19,()=>({name:"Help",gamepad:-1,buttons:[q.VIEW],keys:["h"]})),d=F(t,"context",19,()=>["default"]);u3(()=>{const l=new I2(a(),void 0,!1,s(),i(),o());return l.disabled=e(),E3(d(),l),()=>{l&&A3(d(),l)}}),n3()}class Z1 extends O3{axesDown=-1;changeFocus;constructor(t,e,s,i=!1,o,a,d,l=!1){super(t,s,i,o,a,d,l),this.changeFocus=e}onbuttonpressed(t,e){if(this.disabled||!F3(this.input,t))return!1;const s=this.input;return s.buttons.includes(e)?this.onpressed():(s.buttons_next.includes(e)&&this.changeFocus(1),s.buttons_prev.includes(e)&&this.changeFocus(-1),!1)}onkeypressed(t){if(this.disabled)return!1;const e=this.input,s=t.key.toLowerCase();return e.keys.includes(s)?this.onpressed():(e.keys_next.includes(s)&&this.changeFocus(1),e.keys_prev.includes(s)&&this.changeFocus(-1),!1)}onupdate(t){if(this.disabled||!F3(this.input,t))return;const e=this.input;for(const s of e.axes){const i=t.axes[s];let o=e.sensitivity;if(i<-o&&this.axesDown!=s){this.changeFocus(-1),this.axesDown=s;continue}if(i>o&&this.axesDown!=s){this.changeFocus(1),this.axesDown=s;continue}i<o&&i>-o&&(this.axesDown=-1)}}}var $1=V("<!> <!>",1),tt=V("<li> </li>"),nt=V('<div role="button"><!> <ul></ul> <!></div>');function T2(n,t){t3(t,!0);let e=F(t,"onpressed",3,void 0),s=F(t,"disabled",3,!1),i=F(t,"wrap",3,!0),o=F(t,"style",3,""),a=F(t,"cssclass",3,"vlist"),d=F(t,"selectedIndex",15,0),l=F(t,"focussed",15,0),Q=F(t,"inputMapping",19,()=>({name:"List",gamepad:-1,axes:[1],sensitivity:.05,buttons:[q.DOWN],buttons_prev:[q.DPAD_UP],buttons_next:[q.DPAD_DOWN],keys_prev:["arrowup","w"],keys_next:["arrowdown","s"],keys:["enter","r"]})),w=F(t,"context",19,()=>["default"]),f=F(t,"requiresFocus",3,!0);function L(x){let m="item";return m+=d()===x?" selected":"",l()===x&&(m+=" focussed"),m}function g(x){x>=t.items.length&&(x=i()?0:t.items.length-1),x<0&&(x=i()?t.items.length-1:0),l(x)}function p(){d(l()),e()&&e()(),a2()}let u;function r(){return u}u3(()=>{const x=new Z1(Q(),m=>{g(l()+m)},u,f(),p);return E3(w(),x),()=>{A3(w(),x)}});var c=nt();Q3(c,"tabindex",0);var h=R(c);{var v=x=>{var m=$1(),P=h3(m);p3(P,{text:"↑",get context(){return w()},get keys(){return Q().keys_prev},get buttons(){return Q().buttons_prev},style:"left: 50%;"});var E=M(P,2);p3(E,{get context(){return w()},get keys(){return Q().keys},get buttons(){return Q().buttons},style:"left: 50%; top: 50%"}),D(x,m)};H(h,x=>{A.showHints&&w().includes(A.context)&&x(v)})}var k=M(h,2);R5(k,21,()=>t.items,P5,(x,m,P)=>{var E=tt();E.__pointerdown=()=>{s()||(l(P),p())};var W=R(E,!0);N(E),j(I=>{M3(E,1,I,"svelte-1q9b7hc"),m3(W,y(m))},[()=>S3(L(P))]),v3("pointerenter",E,()=>{s()||l(P)}),D(x,E)}),N(k);var b=M(k,2);return p3(b,{text:"↓",get context(){return w()},get keys(){return Q().keys_next},get buttons(){return Q().buttons_next},style:"left: 50%;"}),N(c),w3(c,x=>u=x,()=>u),j(()=>{M3(c,1,S3(a()),"svelte-1q9b7hc"),U(k,o())}),D(n,c),n3({getElement:r})}i2(["pointerdown"]);class et extends O3{setValue;getValue;min;max;step;constructor(t,e,s,i,o,a,d,l=!1,Q,w,f,L=!1){super(t,d,l,Q,w,f,L),this.setValue=e,this.getValue=s,this.min=i,this.max=o,this.step=a}onbuttonpressed(t,e){if(this.disabled||!F3(this.input,t))return!1;const s=this.input;return s.buttons.includes(e)?super.onbuttonpressed(t,e):(s.buttons_pos.includes(e)&&this.setValue(Math.min(this.max,this.getValue()+this.step)),s.buttons_neg.includes(e)&&this.setValue(Math.max(this.min,this.getValue()-this.step)),!1)}thisKey(t){return this.input.keys.includes(t.key.toLowerCase())||!1}onkeyhold(t){const e=this.input,s=t.key.toLowerCase();super.onkeyhold(t),e.keys_pos.includes(s)&&this.setValue(Math.min(this.max,this.getValue()+this.step)),e.keys_neg.includes(s)&&this.setValue(Math.max(this.min,this.getValue()-this.step))}}var st=V('<div class="vslider svelte-19r2n1p"><!> <input type="range"/> <!></div>');function Z3(n,t){t3(t,!0);let e=F(t,"value",15,50),s=F(t,"onpressed",3,void 0),i=F(t,"min",3,0),o=F(t,"max",3,100),a=F(t,"step",3,10),d=F(t,"disabled",3,!1),l=F(t,"inputMapping",19,()=>({name:"Slider",gamepad:-1,sensitivity:.05,axes:0,buttons:[q.DOWN],buttons_neg:[q.L1,q.DPAD_LEFT],buttons_pos:[q.R1,q.DPAD_RIGHT],keys_pos:["d"],keys_neg:["a"],keys:["e","enter"],invert:!1})),Q=F(t,"context",19,()=>["default"]),w=F(t,"requiresFocus",3,!0),f;function L(){return f}function g(){a2(),s()&&s()()}u3(()=>{const h=new et(l(),v=>{e(v)},()=>e(),i(),o(),a(),f,w(),g);return E3(Q(),h),()=>{A3(Q(),h)}});var p=st(),u=R(p);p3(u,{text:"",get context(){return Q()},get keys(){return l().keys_neg},get buttons(){return l().buttons_neg},style:"position: absolute; top: 60px;"});var r=M(u,2);z5(r),U(r,"",{},{width:"100%;"}),w3(r,h=>f=h,()=>f);var c=M(r,2);return p3(c,{text:"",get context(){return Q()},get keys(){return l().keys_pos},get buttons(){return l().buttons_pos},style:"position: absolute; top: 60px; right: -70px;"}),N(p),j(()=>{Q3(r,"min",i()),Q3(r,"max",o()),Q3(r,"step",a()),r.disabled=d()}),j5(r,e),D(n,p),n3({getElement:L})}class it extends O3{xPos=!1;xNeg=!1;yPos=!1;yNeg=!1;gamepadActive=!0;pos=[0,0];radius;calcPos;updatePosition;constructor(t,e,s,i,o,a=!1){super(t,o,a),this.radius=e,this.calcPos=s,this.updatePosition=i}onrelease(){let t=this.pos[0],e=this.pos[1];(this.xPos||this.xNeg)&&(t=0),(this.yPos||this.yNeg)&&(e=0),!(t==this.pos[0]&&e==this.pos[1])&&(this.calcPos(t*this.radius,e*this.radius),this.pos=[t,e],this.gamepadActive=!0)}onhold(){let t=this.pos[0],e=this.pos[1];this.xPos?t=1:this.xNeg&&(t=-1),this.yPos?e=1:this.yNeg&&(e=-1),!(t==this.pos[0]&&e==this.pos[1])&&(this.calcPos(t*this.radius,e*this.radius),this.pos=[t,e],this.gamepadActive=!1)}updateKeys(t){const e=this.input,s=t.key.toLowerCase();this.xPos=e.key_x_pos.includes(s),this.xNeg=e.key_x_neg.includes(s),this.yPos=e.key_y_pos.includes(s),this.yNeg=e.key_y_neg.includes(s)}thisKey(t){return this.xPos||this.xNeg||this.yPos||this.yNeg}onkeyrelease(t){this.disabled||(this.updateKeys(t),super.onkeyrelease(t))}onkeyhold(t){this.disabled||(this.updateKeys(t),super.onkeyhold(t))}updateButton(t){const e=this.input;this.xPos=e.button_x_pos.includes(t),this.xNeg=e.button_x_neg.includes(t),this.yPos=e.button_y_pos.includes(t),this.yNeg=e.button_y_neg.includes(t)}onbuttonhold(t,e){this.disabled||(this.updateButton(e),super.onbuttonhold(t,e))}onbuttonrelease(t,e){this.disabled||(this.updateButton(e),super.onbuttonrelease(t,e))}onupdate(t){if(this.disabled||!this.gamepadActive||!F3(this.input,t))return;const e=this.input;let s=t.axes[e.axes_x],i=t.axes[e.axes_y];if(e.invert_x&&(s=-s),e.invert_y&&(i=-i),Math.abs(s)<e.deadzoneX&&Math.abs(i)<e.deadzoneY){this.updatePosition(!1,[0,0]);return}this.updatePosition(!0,[s,i])}activateGamepad=()=>{this.disabled||(this.gamepadActive=!0)}}var ot=()=>{},rt=V("<!> <br/>",1),at=V("<!> <br/>",1),lt=V('<div class="hints_container svelte-1annkz1"><div class="hint svelte-1annkz1"><!></div> <div class="hint hint-up svelte-1annkz1"><!> <!></div> <div class="hint hint-down svelte-1annkz1"><!> <!></div> <div class="hint hint-left svelte-1annkz1"><!> <!></div> <div class="hint hint-right svelte-1annkz1"><!> <!></div></div>'),Lt=V('<div id="joystick_area" role="button" class="svelte-1annkz1"><!> <div class="joystick_container svelte-1annkz1"><div class="joystick_back svelte-1annkz1"></div> <div class="joystick_front svelte-1annkz1"></div></div></div>');function gt(n,t){t3(t,!0);let e=F(t,"disabled",3,!1),s=F(t,"size",3,100),i=F(t,"backgroundWidth",3,200),o=F(t,"backgroundHeight",3,200),a=F(t,"color",3,"rgb(106, 191, 163)"),d=F(t,"defaultOpacity",3,.5),l=F(t,"activeOpacity",3,.8),Q=F(t,"border",3,1),w=F(t,"borderColor",3,"black"),f=F(t,"position",31,()=>D3([0,0])),L=F(t,"style",3,"background-color: rgb(215, 219, 221);"),g=F(t,"inputMapping",19,()=>({name:"Virtual Joystick",gamepad:-1,axes_x:0,axes_y:1,button_x_pos:[q.DPAD_RIGHT],button_x_neg:[q.DPAD_LEFT],button_y_pos:[q.DPAD_DOWN],button_y_neg:[q.DPAD_UP],deadzoneX:.05,deadzoneY:.05,key_x_pos:["d"],key_x_neg:["a"],key_y_pos:["s"],key_y_neg:["w"],invert_x:!1,invert_y:!1})),p=F(t,"context",19,()=>["default"]),u=F(t,"requiresFocus",3,!1);const r=s()/2;let c=!1,h,v,k=$(D3(d()));function b(){return h}function x(T){if(e()||!g().gamepad||!c||!T.target)return;const O=T.target.getBoundingClientRect(),J=T.x-O.x,Y=T.y-O.y;v&&(v.gamepadActive=!1,m(J,Y))}function m(T,O){let J=T-i()/2,Y=O-o()/2;P(J,Y)}function P(T,O){const J=Z5(T,O),Y=$5(T,O);let H3=n4(J,r),I3=t4(H3,Y),l3=I3[0]/r,s3=I3[1]/r;if(Math.abs(l3)<g().deadzoneX&&Math.abs(s3)<g().deadzoneY){f([0,0]),S(k,d());return}l3=Math.abs(l3)<1e-6?0:l3,s3=Math.abs(s3)<1e-6?0:s3,S(k,l()),f([l3,s3])}function E(){c=!1,S(k,d()),f([0,0])}function W(T,O){S(k,T?l():d(),!0),f(O)}u3(()=>(v=new it(g(),r,P,W,h,u()),E3(p(),v),()=>{v&&A3(p(),v)}));var I=Lt();v3("pointerup",N3,E),Q3(I,"tabindex",0),I.__keydown=()=>{h.focus()},I.__click=()=>{h.focus()};let K;I.__pointerdown=T=>{e()||(T.stopImmediatePropagation(),c=!0,x(T))},I.__pointerup=()=>{v?.activateGamepad()},I.__pointermove=x,I.__touchstart=[ot],I.__touchend=()=>{v?.activateGamepad()},I.__pointerout=()=>{v?.activateGamepad()};var a3=R(I);{var f3=T=>{var O=lt();let J;var Y=R(O),H3=R(Y);{var I3=_=>{z(_,{type:"generic",input:"axis_left"})},l3=_=>{var r3=r2(),k3=h3(r3);{var U2=z3=>{z(z3,{type:"generic",input:"axis_right"})};H(k3,z3=>{[2,3].includes(g().axes_x)&&[2,3].includes(g().axes_y)&&z3(U2)},!0)}D(_,r3)};H(H3,_=>{[0,1].includes(g().axes_x)&&[0,1].includes(g().axes_y)?_(I3):_(l3,!1)})}N(Y);var s3=M(Y,2),l2=R(s3);{var P2=_=>{z(_,{type:"keyboard_mouse",get input(){return g().key_y_neg[0]}})};H(l2,_=>{g().key_y_neg.length>0&&_(P2)})}var N2=M(l2,2);{var R2=_=>{z(_,{type:"generic",get input(){return g().button_y_neg[0]}})};H(N2,_=>{g().button_y_neg.length>0&&_(R2)})}N(s3);var G3=M(s3,2),L2=R(G3);{var q2=_=>{z(_,{type:"keyboard_mouse",get input(){return g().key_y_pos[0]}})};H(L2,_=>{g().key_y_pos.length>0&&_(q2)})}var D2=M(L2,2);{var S2=_=>{z(_,{type:"generic",get input(){return g().button_y_pos[0]}})};H(D2,_=>{g().button_y_pos.length>0&&_(S2)})}N(G3);var B3=M(G3,2),g2=R(B3);{var O2=_=>{var r3=rt(),k3=h3(r3);z(k3,{type:"keyboard_mouse",get input(){return g().key_x_neg[0]}}),d3(2),D(_,r3)};H(g2,_=>{g().key_x_neg.length>0&&_(O2)})}var H2=M(g2,2);{var G2=_=>{z(_,{type:"generic",get input(){return g().button_x_neg[0]}})};H(H2,_=>{g().button_x_neg.length>0&&_(G2)})}N(B3);var d2=M(B3,2),h2=R(d2);{var B2=_=>{var r3=at(),k3=h3(r3);z(k3,{type:"keyboard_mouse",get input(){return g().key_x_pos[0]}}),d3(2),D(_,r3)};H(h2,_=>{g().key_x_pos.length>0&&_(B2)})}var z2=M(h2,2);{var V2=_=>{z(_,{type:"generic",get input(){return g().button_x_pos[0]}})};H(z2,_=>{g().button_x_pos.length>0&&_(V2)})}N(d2),N(O),j(_=>J=U(O,"",J,_),[()=>({width:i()+"px",height:o()+"px"})]),y3(2,O,()=>b3),y3(1,O,()=>b3),D(T,O)};H(a3,T=>{A.showHints&&p().includes(A.context)&&T(f3)})}var o3=M(a3,2);let C3;var C=R(o3);let G;var e3=M(C,2);let X;return N(o3),N(I),w3(I,T=>h=T,()=>h),j((T,O,J,Y)=>{K=U(I,L(),K,T),C3=U(o3,"",C3,O),G=U(C,"",G,J),X=U(e3,"",X,Y)},[()=>({width:i()+"px",height:o()+"px"}),()=>({left:(i()-s())/2+"px",top:(o()-s())/2+"px"}),()=>({width:s()+"px",height:s()+"px",background:a(),opacity:y(k),transition:"none",border:Q()>0?Q()+"px solid "+w():0}),()=>({left:f()[0]*r+"px",top:f()[1]*r+"px","margin-top":r/2+"px","margin-left":r/2+"px",transition:"opacity 0.2s ease-in-out",width:r+"px",height:r+"px",background:a(),opacity:y(k),border:Q()>0?Q()+"px solid "+w():0})]),v3("pointerleave",I,()=>{v?.activateGamepad()}),D(n,I),n3({getElement:b})}i2(["keydown","click","pointerdown","pointerup","pointermove","touchstart","touchend","pointerout"]);var dt=V('<div id="sidenav" class="sidenav"><!> <!></div>');function ht(n,t){t3(t,!0);const e=["Main","Second","Third","Settings","Fifth"];let s;function i(){return s.getElement()}let o=F(t,"open",15,!1),a=$(0);function d(){e[y(a)],o(!1)}var l=dt();let Q;var w=R(l);{let L=g3(()=>({name:"close side nav",gamepad:-1,buttons:[q.LEFT],keys:["x"]}));q3(w,{cssclassWrapper:"closebtn",onpressed:()=>{o(!1)},get inputMapping(){return y(L)},children:(g,p)=>{d3();var u=R3("×");D(g,u)},$$slots:{default:!0}})}var f=M(w,2);{let L=g3(()=>!o());w3(T2(f,{get disabled(){return y(L)},onpressed:d,get items(){return e},wrap:!0,get selectedIndex(){return y(a)},set selectedIndex(g){S(a,g,!0)}}),g=>s=g,()=>s)}return N(l),j(L=>Q=U(l,"",Q,L),[()=>({width:o()?"250px":"0"})]),D(n,l),n3({getListElement:i})}var Qt=V('<div class="help-modal svelte-zep3tj"><div class="help-content"><!> or <!> toggle help.</div></div>'),wt=V('<!> <!> <!> <!> <div class="background svelte-zep3tj"><main><!> <!> <!> <br/> <!> <br/>  <!><br/> <!><br/> <!> <!> <!><br/> <br/> <!></main></div>',1);function pt(n,t){t3(t,!0);const e=["banana","orange","apple","strawberry"];let s=$(0),i=$(D3([0,0])),o,a,d=$(!0),l=$(!1),Q=$(!0);const w={name:"Hint",gamepad:-1,buttons:[q.VIEW],keys:["h"]};u3(()=>{setTimeout(()=>{S(Q,!1)},2e3)});var f=wt(),L=h3(f);J3(L,{context:["default","my_ctx"],onpressed:()=>{A.showHints=!A.showHints},get inputMapping(){return w}});var g=M(L,2);{let C=g3(()=>({name:"Focus next",gamepad:-1,buttons:[q.TRIGGER_RIGHT],keys:["k"]}));J3(g,{onpressed:()=>{a2()},get inputMapping(){return y(C)}})}var p=M(g,2);{let C=g3(()=>({name:"Focus previous",gamepad:-1,buttons:[q.TRIGGER_LEFT],keys:["i"]}));J3(p,{onpressed:()=>{e4()},get inputMapping(){return y(C)}})}var u=M(p,2);w3(ht(u,{get open(){return y(l)},set open(C){S(l,C,!0)}}),C=>a=C,()=>a);var r=M(u,2),c=R(r);let h;var v=R(c);{var k=C=>{var G=Qt();U(G,"",{},{"pointer-events":"none"});var e3=R(G),X=R(e3);z(X,{type:"keyboard_mouse",get input(){return w.keys[0]},color:"#FFFFFF"});var T=M(X,2);z(T,{type:"ps4",get input(){return w.buttons[0]},color:"#FFFFFF"}),d3(),N(e3),N(G),y3(3,G,()=>b3,()=>({duration:300})),D(C,G)};H(v,C=>{y(Q)&&C(k)})}var b=M(v,2);{let C=g3(()=>({name:"Main Button",gamepad:-1,buttons:[q.RIGHT],keys:["e"]}));q3(b,{onrelease:()=>{o&&(o.changeContext("my_ctx"),S(d,!1))},get inputMapping(){return y(C)},children:(G,e3)=>{d3();var X=R3("switch to context for button2!");D(G,X)},$$slots:{default:!0}})}var x=M(b,2);{let C=g3(()=>({name:"Second Button",gamepad:-1,buttons:[q.LEFT],keys:["q"]}));q3(x,{onrelease:()=>{o&&(o.changeContext("default"),S(d,!0))},context:["my_ctx"],get inputMapping(){return y(C)},get disabled(){return y(d)},children:(G,e3)=>{d3();var X=R3("switch back to default context!");D(G,X)},$$slots:{default:!0}})}var m=M(x,4);{let C=g3(()=>({name:"side nav",gamepad:-1,buttons:[q.UP],keys:["t"]}));q3(m,{onpressed:()=>{S(l,!0),a.getListElement().focus()},get inputMapping(){return y(C)},children:(G,e3)=>{d3();var X=R3("side nav");D(G,X)},$$slots:{default:!0}})}var P=M(m,4);Z3(P,{});var E=M(P,3);Z3(E,{});var W=M(E,3);Z3(W,{});var I=M(W,2);T2(I,{get items(){return e},get selectedIndex(){return y(s)},set selectedIndex(C){S(s,C,!0)}});var K=M(I),a3=M(K);gt(a3,{get position(){return y(i)},set position(C){S(i,C,!0)}});var f3=M(a3,2),o3=M(f3,2),C3=M(o3);w3(s4(C3,{}),C=>o=C,()=>o),N(c),N(r),j((C,G,e3)=>{h=U(c,"",h,C),m3(K,` Selected: ${e[y(s)]??""} `),m3(f3,` x: ${G??""}`),m3(o3,` y: ${e3??""} `)},[()=>({"margin-left":y(l)?"250px":0}),()=>y(i)[0].toFixed(3),()=>y(i)[1].toFixed(3)]),D(n,f),n3()}export{pt as component};
