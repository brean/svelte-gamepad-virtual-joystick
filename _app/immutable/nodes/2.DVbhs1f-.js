import"../chunks/DsnmJJEf.js";import{a as W2,b as K2,w as p2,l as X2,o as u3,e as m3,s as _3,d as i2}from"../chunks/DO4x5Ptl.js";import{j as F2,b as Y2,g as P3,h as B,aa as x3,d as Z3,y,A as j2,r as J2,H as Z2,e as Q2,i as z3,o as L3,ab as k2,af as $2,k as $3,m as t5,l as c3,aB as n5,ax as e5,aC as w2,aj as x2,a8 as s5,aD as i5,n as _2,p as o5,aE as r5,aF as a5,aG as V3,aH as m2,ad as M2,aI as l5,ai as L5,aJ as g5,F as o2,_ as j,aK as d5,ag as h5,ae as Q5,al as u2,aL as w5,aM as u5,aN as f5,aO as c5,aP as v5,aQ as p5,E as F5,aR as k5,aS as x5,q as _5,u as y2,aT as m5,aU as M5,aV as y5,aW as b5,v as E5,aX as k3,aY as A5,t as C5,aZ as I5,B as q3,Y as t3,$ as n3,a_ as t2,C as S,ay as $,c as r2,f as h3,a as D,Z as V,a0 as R,a1 as N,a2 as M,s as T5,a$ as d3,aA as N3,az as g3}from"../chunks/BTBtH8BN.js";import{p as c,i as H,b as w3}from"../chunks/ByhNt_yg.js";function P5(n,t){return t}function N5(n,t,e){for(var s=n.items,i=[],o=t.length,a=0;a<o;a++)l5(t[a].e,i,!0);var Q=o>0&&i.length===0&&e!==null;if(Q){var L=e.parentNode;L5(L),L.append(e),s.clear(),Z(n,t[0].prev,t[o-1].next)}g5(i,()=>{for(var u=0;u<o;u++){var w=t[u];Q||(s.delete(w.k),Z(n,w.prev,w.next)),m2(w.e,!Q)}})}function R5(n,t,e,s,i,o=null){var a=n,Q={flags:t,items:new Map,first:null};{var L=n;a=B?P3(x3(L)):L.appendChild(F2())}B&&Z3();var u=null,w=!1,f=new Map,d=j2(()=>{var r=e();return s5(r)?r:r==null?[]:x2(r)}),h,g;function l(){q5(g,h,Q,f,a,i,t,s,e),o!==null&&(h.length===0?u?_2(u):u=$3(()=>o(a)):u!==null&&o5(u,()=>{u=null}))}Y2(()=>{g??=o2,h=y(d);var r=h.length;if(w&&r===0)return;w=r===0;let v=!1;if(B){var F=J2(a)===Z2;F!==(r===0)&&(a=Q2(),P3(a),z3(!1),v=!0)}if(B){for(var p=null,k,b=0;b<r;b++){if(L3.nodeType===k2&&L3.data===$2){a=L3,v=!0,z3(!1);break}var x=h[b],m=s(x,b);k=n2(L3,Q,p,null,x,m,b,i,t,e),Q.items.set(m,k),p=k}r>0&&P3(Q2())}if(B)r===0&&o&&(u=$3(()=>o(a)));else if(t5()){var P=new Set,A=c3;for(b=0;b<r;b+=1){x=h[b],m=s(x,b);var W=Q.items.get(m)??f.get(m);W?b2(W,x,b):(k=n2(null,Q,null,null,x,m,b,i,t,e,!0),f.set(m,k)),P.add(m)}for(const[I,K]of Q.items)P.has(I)||A.skipped_effects.add(K.e);A.add_callback(l)}else l();v&&z3(!0),y(d)}),B&&(a=L3)}function q5(n,t,e,s,i,o,a,Q,L){var u=t.length,w=e.items,f=e.first,d=f,h,g=null,l=[],r=[],v,F,p,k;for(k=0;k<u;k+=1){if(v=t[k],F=Q(v,k),p=w.get(F),p===void 0){var b=s.get(F);if(b!==void 0){s.delete(F),w.set(F,b);var x=g?g.next:d;Z(e,g,b),Z(e,b,x),U3(b,x,i),g=b}else{var m=d?d.e.nodes_start:i;g=n2(m,e,g,g===null?e.first:g.next,v,F,k,o,a,L)}w.set(F,g),l=[],r=[],d=g.next;continue}if(b2(p,v,k),(p.e.f&V3)!==0&&_2(p.e),p!==d){if(h!==void 0&&h.has(p)){if(l.length<r.length){var P=r[0],A;g=P.prev;var W=l[0],I=l[l.length-1];for(A=0;A<l.length;A+=1)U3(l[A],P,i);for(A=0;A<r.length;A+=1)h.delete(r[A]);Z(e,W.prev,I.next),Z(e,g,W),Z(e,I,P),d=P,g=I,k-=1,l=[],r=[]}else h.delete(p),U3(p,d,i),Z(e,p.prev,p.next),Z(e,p,g===null?e.first:g.next),Z(e,g,p),g=p;continue}for(l=[],r=[];d!==null&&d.k!==F;)(d.e.f&V3)===0&&(h??=new Set).add(d),r.push(d),d=d.next;if(d===null)continue;p=d}l.push(p),g=p,d=p.next}if(d!==null||h!==void 0){for(var K=h===void 0?[]:x2(h);d!==null;)(d.e.f&V3)===0&&K.push(d),d=d.next;var a3=K.length;if(a3>0){var f3=u===0?i:null;N5(e,K,f3)}}n.first=e.first&&e.first.e,n.last=g&&g.e;for(var o3 of s.values())m2(o3.e);s.clear()}function b2(n,t,e,s){n5(n.v,t),n.i=e}function n2(n,t,e,s,i,o,a,Q,L,u,w){var f=(L&r5)!==0,d=(L&a5)===0,h=f?d?e5(i,!1,!1):w2(i):i,g=(L&i5)===0?a:w2(a),l={i:g,v:h,k:o,a:null,e:null,prev:e,next:s};try{if(n===null){var r=document.createDocumentFragment();r.append(n=F2())}return l.e=$3(()=>Q(n,h,g,u),B),l.e.prev=e&&e.e,l.e.next=s&&s.e,e===null?w||(t.first=l):(e.next=l,e.e.next=l.e),s!==null&&(s.prev=l,s.e.prev=l.e),l}finally{}}function U3(n,t,e){for(var s=n.next?n.next.e.nodes_start:e,i=t?t.e.nodes_start:e,o=n.e.nodes_start;o!==null&&o!==s;){var a=M2(o);i.before(o),o=a}}function Z(n,t,e){t===null?n.first=e:(t.next=e,t.e.next=e&&e.e),e!==null&&(e.prev=t,e.e.prev=t&&t.e)}function D5(n,t,e=!1,s=!1,i=!1){var o=n,a="";j(()=>{var Q=o2;if(a===(a=t()??"")){B&&Z3();return}if(Q.nodes_start!==null&&(d5(Q.nodes_start,Q.nodes_end),Q.nodes_start=Q.nodes_end=null),a!==""){if(B){L3.data;for(var L=Z3(),u=L;L!==null&&(L.nodeType!==k2||L.data!=="");)u=L,L=M2(L);if(L===null)throw h5(),Q5;u2(L3,u),o=P3(L);return}var w=a+"";e?w=`<svg>${w}</svg>`:s&&(w=`<math>${w}</math>`);var f=w5(w);if((e||s)&&(f=x3(f)),u2(x3(f),f.lastChild),e||s)for(;x3(f);)o.before(x3(f));else o.before(f)}})}function E2(n){var t,e,s="";if(typeof n=="string"||typeof n=="number")s+=n;else if(typeof n=="object")if(Array.isArray(n)){var i=n.length;for(t=0;t<i;t++)n[t]&&(e=E2(n[t]))&&(s&&(s+=" "),s+=e)}else for(e in n)n[e]&&(s&&(s+=" "),s+=e);return s}function S5(){for(var n,t,e=0,s="",i=arguments.length;e<i;e++)(n=arguments[e])&&(t=E2(n))&&(s&&(s+=" "),s+=t);return s}function D3(n){return typeof n=="object"?S5(n):n??""}function O5(n,t,e){var s=n==null?"":""+n;return t&&(s=s?s+" "+t:t),s===""?null:s}function f2(n,t=!1){var e=t?" !important;":";",s="";for(var i in n){var o=n[i];o!=null&&o!==""&&(s+=" "+i+": "+o+e)}return s}function W3(n){return n[0]!=="-"||n[1]!=="-"?n.toLowerCase():n}function H5(n,t){if(t){var e="",s,i;if(Array.isArray(t)?(s=t[0],i=t[1]):s=t,n){n=String(n).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var o=!1,a=0,Q=!1,L=[];s&&L.push(...Object.keys(s).map(W3)),i&&L.push(...Object.keys(i).map(W3));var u=0,w=-1;const l=n.length;for(var f=0;f<l;f++){var d=n[f];if(Q?d==="/"&&n[f-1]==="*"&&(Q=!1):o?o===d&&(o=!1):d==="/"&&n[f+1]==="*"?Q=!0:d==='"'||d==="'"?o=d:d==="("?a++:d===")"&&a--,!Q&&o===!1&&a===0){if(d===":"&&w===-1)w=f;else if(d===";"||f===l-1){if(w!==-1){var h=W3(n.substring(u,w).trim());if(!L.includes(h)){d!==";"&&f++;var g=n.substring(u,f).trim();e+=" "+g+";"}}u=f+1,w=-1}}}}return s&&(e+=f2(s)),i&&(e+=f2(i,!0)),e=e.trim(),e===""?null:e}return n==null?null:String(n)}function M3(n,t,e,s,i,o){var a=n.__className;if(B||a!==e||a===void 0){var Q=O5(e,s);(!B||Q!==n.getAttribute("class"))&&(Q==null?n.removeAttribute("class"):n.className=Q),n.__className=e}return o}function K3(n,t={},e,s){for(var i in e){var o=e[i];t[i]!==o&&(e[i]==null?n.style.removeProperty(i):n.style.setProperty(i,o,s))}}function U(n,t,e,s){var i=n.__style;if(B||i!==t){var o=H5(t,s);(!B||o!==n.getAttribute("style"))&&(o==null?n.removeAttribute("style"):n.style.cssText=o),n.__style=t}else s&&(Array.isArray(s)?(K3(n,e?.[0],s[0]),K3(n,e?.[1],s[1],"important")):K3(n,e,s));return s}const G5=Symbol("is custom element"),B5=Symbol("is html");function z5(n){if(B){var t=!1,e=()=>{if(!t){if(t=!0,n.hasAttribute("value")){var s=n.value;Q3(n,"value",null),n.value=s}if(n.hasAttribute("checked")){var i=n.checked;Q3(n,"checked",null),n.checked=i}}};n.__on_r=e,v5(e),W2()}}function Q3(n,t,e,s){var i=V5(n);B&&(i[t]=n.getAttribute(t),t==="src"||t==="srcset"||t==="href"&&n.nodeName==="LINK")||i[t]!==(i[t]=e)&&(t==="loading"&&(n[p5]=e),e==null?n.removeAttribute(t):typeof e!="string"&&U5(n).includes(t)?n[t]=e:n.setAttribute(t,e))}function V5(n){return n.__attributes??={[G5]:n.nodeName.includes("-"),[B5]:n.namespaceURI===u5}}var c2=new Map;function U5(n){var t=c2.get(n.nodeName);if(t)return t;c2.set(n.nodeName,t=[]);for(var e,s=n,i=Element.prototype;i!==s;){e=c5(s);for(var o in e)e[o].set&&t.push(o);s=f5(s)}return t}const W5=()=>performance.now(),i3={tick:n=>requestAnimationFrame(n),now:()=>W5(),tasks:new Set};function A2(){const n=i3.now();i3.tasks.forEach(t=>{t.c(n)||(i3.tasks.delete(t),t.f())}),i3.tasks.size!==0&&i3.tick(A2)}function K5(n){let t;return i3.tasks.size===0&&i3.tick(A2),{promise:new Promise(e=>{i3.tasks.add(t={c:n,f:e})}),abort(){i3.tasks.delete(t)}}}function T3(n,t){p2(()=>{n.dispatchEvent(new CustomEvent(t))})}function X5(n){if(n==="float")return"cssFloat";if(n==="offset")return"cssOffset";if(n.startsWith("--"))return n;const t=n.split("-");return t.length===1?t[0]:t[0]+t.slice(1).map(e=>e[0].toUpperCase()+e.slice(1)).join("")}function v2(n){const t={},e=n.split(";");for(const s of e){const[i,o]=s.split(":");if(!i||o===void 0)break;const a=X5(i.trim());t[a]=o.trim()}return t}const Y5=n=>n;function y3(n,t,e,s){var i=(n&M5)!==0,o=(n&y5)!==0,a=i&&o,Q=(n&m5)!==0,L=a?"both":i?"in":"out",u,w=t.inert,f=t.style.overflow,d,h;function g(){return p2(()=>u??=e()(t,s?.()??{},{direction:L}))}var l={is_global:Q,in(){if(t.inert=w,!i){h?.abort(),h?.reset?.();return}o||d?.abort(),T3(t,"introstart"),d=e2(t,g(),h,1,()=>{T3(t,"introend"),d?.abort(),d=u=void 0,t.style.overflow=f})},out(p){if(!o){p?.(),u=void 0;return}t.inert=!0,T3(t,"outrostart"),h=e2(t,g(),d,0,()=>{T3(t,"outroend"),p?.()})},stop:()=>{d?.abort(),h?.abort()}},r=o2;if((r.transitions??=[]).push(l),i&&K2){var v=Q;if(!v){for(var F=r.parent;F&&(F.f&F5)!==0;)for(;(F=F.parent)&&(F.f&k5)===0;);v=!F||(F.f&x5)!==0}v&&_5(()=>{y2(()=>l.in())})}}function e2(n,t,e,s,i){var o=s===1;if(b5(t)){var a,Q=!1;return E5(()=>{if(!Q){var r=t({direction:o?"in":"out"});a=e2(n,r,e,s,i)}}),{abort:()=>{Q=!0,a?.abort()},deactivate:()=>a.deactivate(),reset:()=>a.reset(),t:()=>a.t()}}if(e?.deactivate(),!t?.duration)return i(),{abort:k3,deactivate:k3,reset:k3,t:()=>s};const{delay:L=0,css:u,tick:w,easing:f=Y5}=t;var d=[];if(o&&e===void 0&&(w&&w(0,1),u)){var h=v2(u(0,1));d.push(h,h)}var g=()=>1-s,l=n.animate(d,{duration:L,fill:"forwards"});return l.onfinish=()=>{l.cancel();var r=e?.t()??1-s;e?.abort();var v=s-r,F=t.duration*Math.abs(v),p=[];if(F>0){var k=!1;if(u)for(var b=Math.ceil(F/16.666666666666668),x=0;x<=b;x+=1){var m=r+v*f(x/b),P=v2(u(m,1-m));p.push(P),k||=P.overflow==="hidden"}k&&(n.style.overflow="hidden"),g=()=>{var A=l.currentTime;return r+v*f(A/F)},w&&K5(()=>{if(l.playState!=="running")return!1;var A=g();return w(A,1-A),!0})}l=n.animate(p,{duration:F,fill:"forwards"}),l.onfinish=()=>{g=()=>s,w?.(s,1-s),i()}},{abort:()=>{l&&(l.cancel(),l.effect=null,l.onfinish=k3)},deactivate:()=>{i=k3},reset:()=>{s===0&&w?.(1,0)},t:()=>g()}}function j5(n,t,e=t){var s=A5(),i=new WeakSet;X2(n,"input",o=>{var a=o?n.defaultValue:n.value;if(a=X3(n)?Y3(a):a,e(a),c3!==null&&i.add(c3),s&&a!==(a=t())){var Q=n.selectionStart,L=n.selectionEnd;n.value=a??"",L!==null&&(n.selectionStart=Q,n.selectionEnd=Math.min(L,n.value.length))}}),(B&&n.defaultValue!==n.value||y2(t)==null&&n.value)&&(e(X3(n)?Y3(n.value):n.value),c3!==null&&i.add(c3)),C5(()=>{var o=t();if(n===document.activeElement){var a=I5??c3;if(i.has(a))return}X3(n)&&o===Y3(n.value)||n.type==="date"&&!o&&!n.value||o!==n.value&&(n.value=o??"")})}function X3(n){var t=n.type;return t==="number"||t==="range"}function Y3(n){return n===""?null:+n}const J5=n=>n;function b3(n,{delay:t=0,duration:e=400,easing:s=J5}={}){const i=+getComputedStyle(n).opacity;return{delay:t,duration:e,easing:s,css:o=>`opacity: ${o*i}`}}const Z5=(n,t)=>Math.sqrt(n**2+t**2),$5=(n,t)=>Math.atan2(t,n),t4=(n,t)=>[n*Math.cos(t),n*Math.sin(t)],n4=(n,t)=>Math.min(Math.max(-t,n),t);function p3(n,t){return n.gamepad===-1||n.gamepad===t.index}function C2(n){const t=document.activeElement,e=Array.from(document.querySelectorAll('input, select, textarea, button, [tabindex]:not([tabindex="-1"])'));if(!t)return;let s=e.indexOf(t);for(let i=1;i<e.length;i++){let o=(s+i*n)%e.length;o<0&&(o=e.length-1,s=o);const a=e[o];if(!a.hasAttribute("disabled"))return a}}function e4(){const n=C2(-1);n&&n.focus()}function a2(){const n=C2(1);n&&n.focus()}class S3{focusElement;requiresFocus;input;disabled=!1;onpressedCallback;onholdCallback;onreleaseCallback;consumePress;constructor(t,e,s=!1,i,o,a,Q=!1){this.onpressedCallback=i,this.onholdCallback=o,this.onreleaseCallback=a,this.focusElement=e,this.input=t,this.requiresFocus=s,this.consumePress=Q}onpressed(){return this.disabled?!1:(this.onpressedCallback&&this.onpressedCallback(),this.consumePress)}onhold(){this.onholdCallback&&this.onholdCallback()}onrelease(){this.onreleaseCallback&&this.onreleaseCallback()}thisGamepadButton(t,e){return p3(this.input,t)}onbuttonpressed(t,e){return this.onpressed()}onbuttonrelease(t,e){this.onrelease()}onbuttonhold(t,e){this.onhold()}onupdate(t){}thisKey(t){return!1}onkeypressed(t){return this.thisKey(t)&&this.onpressed()}onkeyrelease(t){this.thisKey(t)&&this.onrelease()}onkeyhold(t){this.thisKey(t)&&this.onhold()}}const E=q3({components:{},activeComponents:[],showHints:!1,context:"default"}),s2=n=>{E.activeComponents.includes(n)||E.activeComponents.push(n)},E3=(n,t)=>{n.forEach(e=>{E.components[e]||(E.components[e]=[]),E.components[e].push(t)}),!t.requiresFocus&&n.includes("default")&&s2(t),t.focusElement&&t.requiresFocus&&(t.focusElement.addEventListener("focus",()=>{n.includes(E.context)&&s2(t)}),t.focusElement.addEventListener("blur",()=>{E.activeComponents.splice(E.activeComponents.indexOf(t),1)}))},A3=(n,t)=>{n.forEach(e=>{E.components[e]&&E.components[e].splice(E.components[e].indexOf(t),1)}),E.activeComponents.includes(t)&&E.activeComponents.slice(E.activeComponents.indexOf(t))};function s4(n,t){t3(t,!0);let e=c(t,"updateUsingAnimationFrame",3,!1),s=c(t,"updateUsingInterval",3,!0),i=c(t,"timeout",3,1e3/25),o=!0;const a=g=>{E.activeComponents.forEach(r=>{r.focusElement&&r.focusElement.blur()}),E.activeComponents=[],E.components[g].forEach(r=>{(!r.requiresFocus||r.focusElement===document.activeElement)&&s2(r)}),E.context=g};let Q={},L={};const u=()=>{let g=E.activeComponents;for(let l of navigator.getGamepads())if(l){for(let r=0;r<l.buttons.length;r++){if(l.buttons[r].pressed&&(g.forEach(v=>{v.thisGamepadButton(l,r)&&v.onbuttonhold(l,r)}),!Q[r])){Q[r]=!0;for(let v of g)if(v.thisGamepadButton(l,r)&&v.onbuttonpressed(l,r)===!0)break}Q[r]&&!l.buttons[r].pressed&&(Q[r]=!1,g.forEach(v=>{v.thisGamepadButton(l,r)&&v.onbuttonrelease(l,r)}))}g.forEach(r=>{p3(r.input,l)&&r.onupdate(l)})}},w=()=>{u(),o&&requestAnimationFrame(w)};u3(()=>{let g;return e()?(o=!0,w()):s()&&(g=setInterval(u,i())),()=>{g&&clearInterval(g),o=!1,E.activeComponents=[]}});const f=g=>{let l=E.activeComponents;for(let r of l)if(r.onkeypressed(g)===!0)break},d=g=>{const l=g.key.toLowerCase();L[l]||f(g);let r=E.activeComponents;L[l]=!0,r.forEach(v=>{v.onkeyhold(g)})},h=g=>{const l=g.key.toLowerCase();delete L[l],E.activeComponents.forEach(v=>{v.onkeyrelease(g)})};return m3("keydown",t2,d),m3("keyup",t2,h),n3({changeContext:a})}class q{static DOWN=0;static RIGHT=1;static LEFT=2;static UP=3;static BUMPER_LEFT=4;static BUMPER_RIGHT=5;static TRIGGER_LEFT=6;static TRIGGER_RIGHT=7;static VIEW=8;static MENU=9;static AXIS_BUTTON_LEFT=10;static AXIS_BUTTON_RIGHT=11;static DPAD_UP=12;static DPAD_DOWN=13;static DPAD_LEFT=14;static DPAD_RIGHT=15;static HOME=16;static CROSS=0;static CIRCLE=1;static SQUARE=2;static TRIANGLE=3;static L1=4;static R1=5;static L2=6;static R2=7;static SHARE=8;static OPTIONS=9;static PS=16;static A=0;static B=1;static X=2;static Y=3;static LB=4;static RB=5;static TL=6;static TR=7;static BACK=8;static START=9;static XBOX=16}const i4=`<svg width="64" height="64" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs/>
  <g>
    <path
         stroke="none"
...
</svg>`;var X1=V('<div class="svg-container svelte-6pjcsf"><!></div>');function z(n,t){t3(t,!0);let e=c(t,"width",3,40),s=c(t,"height",3,40),i=c(t,"color",3,"#666666");const o={0:A1,1:C1,2:I1,3:T1,4:P1,5:N1,6:R1,7:q1,8:D1,9:S1,10:O1,11:H1,12:G1,13:B1,14:z1,15:V1,16:U1,axis_left:W1,axis_right:K1},a={"/":l4,"*":L4,",":g4,".":d4,":":h4,";":Q4,"[":w4,"]":u4,"+":f4,"-":c4,"~":v4," ":p4,'"':F4,backspace:k4,capslock:x4,tab:_4,shift:m4,arrowleft:M4,arrowright:y4,arrowup:b4,arrowdown:E4,pagedown:A4,pageup:C4,end:I4,home:T4,control:P4,enter:N4,a:R4,b:q4,c:D4,d:S4,e:O4,f:H4,g:G4,h:B4,i:z4,j:V4,k:U4,l:W4,m:K4,n:X4,o:Y4,p:j4,q:J4,r:Z4,s:$4,t:t1,u:n1,v:e1,w:s1,x:i1,y:o1,z:r1,0:a1,1:l1,2:L1,3:g1,4:d1,5:h1,6:Q1,7:w1,8:u1,9:f1,f1:c1,f2:v1,f3:p1,f4:F1,f5:k1,f6:x1,f7:_1,f8:m1,f9:M1,f10:y1,f11:b1,f12:E1},Q={0:i4,1:o4,2:r4,3:a4};let L=$(void 0);switch(t.type,["ps4","ps5"].includes(t.type),t.type){case"keyboard_mouse":let d=t.input.toLowerCase();S(L,a[d],!0);break;case"ps4":S(L,o[t.input],!0);break;case"generic":t.input in Q?S(L,Q[t.input],!0):S(L,o[t.input],!0)}var u=r2(),w=h3(u);{var f=d=>{var h=X1();let g;var l=R(h);D5(l,()=>y(L).replace("<g>",`<g transform="scale(${Math.min(e()/64,s()/64)})">`).replace('fill="#FFFFFF"',`fill="${i()}"`)),N(h),j(r=>g=U(h,"",g,r),[()=>({height:`${s()??""}px`,width:`${e()??""}px`})]),D(d,h)};H(w,d=>{y(L)&&d(f)})}D(n,u),n3()}var Y1=V('<div><div class="hint"> <!> <!></div></div>');function v3(n,t){t3(t,!0);let e=c(t,"context",19,()=>["default"]),s=c(t,"text",3,""),i=c(t,"class",3,"hint-container"),o=c(t,"style",3,"");var a=r2(),Q=h3(a);{var L=u=>{var w=Y1(),f=R(w),d=R(f),h=M(d);{var g=v=>{z(v,{type:"keyboard_mouse",get input(){return t.keys[0]}})};H(h,v=>{t.keys.length>0&&v(g)})}var l=M(h,2);{var r=v=>{z(v,{type:"generic",get input(){return t.buttons[0]}})};H(l,v=>{t.buttons.length>0&&v(r)})}N(f),N(w),j(()=>{M3(w,1,D3(i())),U(w,o()),_3(d,`${s()??""} `)}),y3(2,w,()=>b3),y3(1,w,()=>b3),D(u,w)};H(Q,u=>{E.showHints&&e().includes(E.context)&&u(L)})}D(n,a),n3()}class I2 extends S3{thisGamepadButton(t,e){return super.thisGamepadButton(t,e)&&this.input.buttons.includes(e)}thisKey(t){return this.input.keys.includes(t.key.toLowerCase())||!1}}var j1=(n,t)=>{y(t)?.onpressed(),setTimeout(()=>{y(t)?.onrelease()},50)},J1=V("<div><button><!></button> <!></div>");function R3(n,t){t3(t,!0);let e=c(t,"disabled",3,!1),s=c(t,"onpressed",3,void 0),i=c(t,"onhold",3,void 0),o=c(t,"onrelease",3,void 0),a=c(t,"onpointerout",3,void 0),Q=c(t,"style",3,""),L=c(t,"cssclass",3,"vbutton"),u=c(t,"cssclassWrapper",3,"button-wrapper"),w=c(t,"inputMapping",19,()=>({name:"",gamepad:-1,buttons:[q.DOWN],keys:["e"," "]})),f=c(t,"context",19,()=>["default"]),d=c(t,"requiresFocus",3,!1),h=c(t,"consumePress",3,!1),g=$(""),l,r=$(void 0);function v(){return l}u3(()=>(S(r,new F(w(),l,d(),s(),i(),o(),h()),!0),E3(f(),y(r)),()=>{y(r)&&A3(f(),y(r))}));class F extends I2{onpressed(){return S(g,"button_clicked "),super.onpressed()}onrelease(){S(g,""),super.onrelease()}}var p=J1(),k=R(p);k.__pointerdown=function(...m){y(r)?.onpressed?.apply(this,m)},k.__click=[j1,r],k.__pointerup=function(...m){y(r)?.onrelease?.apply(this,m)},k.__pointerout=function(...m){a()?.apply(this,m)};var b=R(k);T5(b,()=>t.children),N(k),w3(k,m=>l=m,()=>l);var x=M(k,2);return v3(x,{get context(){return f()},get keys(){return w().keys},get buttons(){return w().buttons},style:"left: 50%;"}),N(p),j(()=>{M3(p,1,D3(u()),"svelte-bpza0d"),U(k,Q()),M3(k,1,y(g)+L(),"svelte-bpza0d"),k.disabled=e()}),D(n,p),n3({getElement:v})}i2(["pointerdown","click","pointerup","pointerout"]);function j3(n,t){t3(t,!0);let e=c(t,"disabled",3,!1),s=c(t,"onpressed",3,void 0),i=c(t,"onhold",3,void 0),o=c(t,"onrelease",3,void 0),a=c(t,"inputMapping",19,()=>({name:"Help",gamepad:-1,buttons:[q.VIEW],keys:["h"]})),Q=c(t,"context",19,()=>["default"]);u3(()=>{const L=new I2(a(),void 0,!1,s(),i(),o());return L.disabled=e(),E3(Q(),L),()=>{L&&A3(Q(),L)}}),n3()}class Z1 extends S3{axesDown=-1;changeFocus;constructor(t,e,s,i=!1,o,a,Q,L=!1){super(t,s,i,o,a,Q,L),this.changeFocus=e}onbuttonpressed(t,e){if(this.disabled||!p3(this.input,t))return!1;const s=this.input;return s.buttons.includes(e)?this.onpressed():(s.buttons_next.includes(e)&&this.changeFocus(1),s.buttons_prev.includes(e)&&this.changeFocus(-1),!1)}onkeypressed(t){if(this.disabled)return!1;const e=this.input,s=t.key.toLowerCase();return e.keys.includes(s)?this.onpressed():(e.keys_next.includes(s)&&this.changeFocus(1),e.keys_prev.includes(s)&&this.changeFocus(-1),!1)}onupdate(t){if(this.disabled||!p3(this.input,t))return;const e=this.input;for(const s of e.axes){const i=t.axes[s];let o=e.sensitivity;if(i<-o&&this.axesDown!=s){this.changeFocus(-1),this.axesDown=s;continue}if(i>o&&this.axesDown!=s){this.changeFocus(1),this.axesDown=s;continue}i<o&&i>-o&&(this.axesDown=-1)}}}var $1=V("<!> <!>",1),tt=V("<li> </li>"),nt=V('<div role="button"><!> <ul></ul> <!></div>');function T2(n,t){t3(t,!0);let e=c(t,"onpressed",3,void 0),s=c(t,"disabled",3,!1),i=c(t,"wrap",3,!0),o=c(t,"style",3,""),a=c(t,"cssclass",3,"vlist"),Q=c(t,"selectedIndex",15,0),L=c(t,"focussed",15,0),u=c(t,"inputMapping",19,()=>({name:"List",gamepad:-1,axes:[1],sensitivity:.05,buttons:[q.DOWN],buttons_prev:[q.DPAD_UP],buttons_next:[q.DPAD_DOWN],keys_prev:["arrowup","w"],keys_next:["arrowdown","s"],keys:["enter","r"]})),w=c(t,"context",19,()=>["default"]),f=c(t,"requiresFocus",3,!0);function d(x){let m="item";return m+=Q()===x?" selected":"",L()===x&&(m+=" focussed"),m}function h(x){x>=t.items.length&&(x=i()?0:t.items.length-1),x<0&&(x=i()?t.items.length-1:0),L(x)}function g(){Q(L()),e()&&e()(),a2()}let l;function r(){return l}u3(()=>{const x=new Z1(u(),m=>{h(L()+m)},l,f(),g);return E3(w(),x),()=>{A3(w(),x)}});var v=nt();Q3(v,"tabindex",0);var F=R(v);{var p=x=>{var m=$1(),P=h3(m);v3(P,{text:"↑",get context(){return w()},get keys(){return u().keys_prev},get buttons(){return u().buttons_prev},style:"left: 50%;"});var A=M(P,2);v3(A,{get context(){return w()},get keys(){return u().keys},get buttons(){return u().buttons},style:"left: 50%; top: 50%"}),D(x,m)};H(F,x=>{E.showHints&&w().includes(E.context)&&x(p)})}var k=M(F,2);R5(k,21,()=>t.items,P5,(x,m,P)=>{var A=tt();A.__pointerdown=()=>{s()||(L(P),g())};var W=R(A,!0);N(A),j(I=>{M3(A,1,I,"svelte-1q9b7hc"),_3(W,y(m))},[()=>D3(d(P))]),m3("pointerenter",A,()=>{s()||L(P)}),D(x,A)}),N(k);var b=M(k,2);return v3(b,{text:"↓",get context(){return w()},get keys(){return u().keys_next},get buttons(){return u().buttons_next},style:"left: 50%;"}),N(v),w3(v,x=>l=x,()=>l),j(()=>{M3(v,1,D3(a()),"svelte-1q9b7hc"),U(k,o())}),D(n,v),n3({getElement:r})}i2(["pointerdown"]);class et extends S3{setValue;getValue;min;max;step;constructor(t,e,s,i,o,a,Q,L=!1,u,w,f,d=!1){super(t,Q,L,u,w,f,d),this.setValue=e,this.getValue=s,this.min=i,this.max=o,this.step=a}onbuttonpressed(t,e){if(this.disabled||!p3(this.input,t))return!1;const s=this.input;return s.buttons.includes(e)?super.onbuttonpressed(t,e):(s.buttons_pos.includes(e)&&this.setValue(Math.min(this.max,this.getValue()+this.step)),s.buttons_neg.includes(e)&&this.setValue(Math.max(this.min,this.getValue()-this.step)),!1)}thisKey(t){return this.input.keys.includes(t.key.toLowerCase())||!1}onkeyhold(t){const e=this.input,s=t.key.toLowerCase();super.onkeyhold(t),e.keys_pos.includes(s)&&this.setValue(Math.min(this.max,this.getValue()+this.step)),e.keys_neg.includes(s)&&this.setValue(Math.max(this.min,this.getValue()-this.step))}}var st=V('<div class="vslider svelte-19r2n1p"><!> <input type="range"/> <!></div>');function J3(n,t){t3(t,!0);let e=c(t,"value",15,50),s=c(t,"onpressed",3,void 0),i=c(t,"min",3,0),o=c(t,"max",3,100),a=c(t,"step",3,10),Q=c(t,"disabled",3,!1),L=c(t,"inputMapping",19,()=>({name:"Slider",gamepad:-1,sensitivity:.05,axes:0,buttons:[q.DOWN],buttons_neg:[q.L1,q.DPAD_LEFT],buttons_pos:[q.R1,q.DPAD_RIGHT],keys_pos:["d"],keys_neg:["a"],keys:["e","enter"],invert:!1})),u=c(t,"context",19,()=>["default"]),w=c(t,"requiresFocus",3,!0),f;function d(){return f}function h(){a2(),s()&&s()()}u3(()=>{const F=new et(L(),p=>{e(p)},()=>e(),i(),o(),a(),f,w(),h);return E3(u(),F),()=>{A3(u(),F)}});var g=st(),l=R(g);v3(l,{text:"",get context(){return u()},get keys(){return L().keys_neg},get buttons(){return L().buttons_neg},style:"position: absolute; top: 60px;"});var r=M(l,2);z5(r),U(r,"",{},{width:"100%;"}),w3(r,F=>f=F,()=>f);var v=M(r,2);return v3(v,{text:"",get context(){return u()},get keys(){return L().keys_pos},get buttons(){return L().buttons_pos},style:"position: absolute; top: 60px; right: -70px;"}),N(g),j(()=>{Q3(r,"min",i()),Q3(r,"max",o()),Q3(r,"step",a()),r.disabled=Q()}),j5(r,e),D(n,g),n3({getElement:d})}class it extends S3{xPos=!1;xNeg=!1;yPos=!1;yNeg=!1;gamepadActive=!0;pos=[0,0];radius;calcPos;updatePosition;constructor(t,e,s,i,o,a=!1){super(t,o,a),this.radius=e,this.calcPos=s,this.updatePosition=i}onrelease(){let t=this.pos[0],e=this.pos[1];(this.xPos||this.xNeg)&&(t=0),(this.yPos||this.yNeg)&&(e=0),!(t==this.pos[0]&&e==this.pos[1])&&(this.calcPos(t*this.radius,e*this.radius),this.pos=[t,e],this.gamepadActive=!0)}onhold(){let t=this.pos[0],e=this.pos[1];this.xPos?t=1:this.xNeg&&(t=-1),this.yPos?e=1:this.yNeg&&(e=-1),!(t==this.pos[0]&&e==this.pos[1])&&(this.calcPos(t*this.radius,e*this.radius),this.pos=[t,e],this.gamepadActive=!1)}updateKeys(t){const e=this.input,s=t.key.toLowerCase();this.xPos=e.key_x_pos.includes(s),this.xNeg=e.key_x_neg.includes(s),this.yPos=e.key_y_pos.includes(s),this.yNeg=e.key_y_neg.includes(s)}thisKey(t){return this.xPos||this.xNeg||this.yPos||this.yNeg}onkeyrelease(t){this.disabled||(this.updateKeys(t),super.onkeyrelease(t))}onkeyhold(t){this.disabled||(this.updateKeys(t),super.onkeyhold(t))}updateButton(t){const e=this.input;this.xPos=e.button_x_pos.includes(t),this.xNeg=e.button_x_neg.includes(t),this.yPos=e.button_y_pos.includes(t),this.yNeg=e.button_y_neg.includes(t)}onbuttonhold(t,e){this.disabled||(this.updateButton(e),super.onbuttonhold(t,e))}onbuttonrelease(t,e){this.disabled||(this.updateButton(e),super.onbuttonrelease(t,e))}onupdate(t){if(this.disabled||!this.gamepadActive||!p3(this.input,t))return;const e=this.input;let s=t.axes[e.axes_x],i=t.axes[e.axes_y];if(e.invert_x&&(s=-s),e.invert_y&&(i=-i),Math.abs(s)<e.deadzoneX&&Math.abs(i)<e.deadzoneY){this.updatePosition(!1,[0,0]);return}this.updatePosition(!0,[s,i])}activateGamepad=()=>{this.disabled||(this.gamepadActive=!0)}}var ot=()=>{},rt=V("<!> <br/>",1),at=V("<!> <br/>",1),lt=V('<div class="hints_container svelte-1annkz1"><div class="hint svelte-1annkz1"><!></div> <div class="hint hint-up svelte-1annkz1"><!> <!></div> <div class="hint hint-down svelte-1annkz1"><!> <!></div> <div class="hint hint-left svelte-1annkz1"><!> <!></div> <div class="hint hint-right svelte-1annkz1"><!> <!></div></div>'),Lt=V('<div id="joystick_area" role="button" class="svelte-1annkz1"><!> <div class="joystick_container svelte-1annkz1"><div class="joystick_back svelte-1annkz1"></div> <div class="joystick_front svelte-1annkz1"></div></div></div>');function gt(n,t){t3(t,!0);let e=c(t,"disabled",3,!1),s=c(t,"size",3,100),i=c(t,"backgroundWidth",3,200),o=c(t,"backgroundHeight",3,200),a=c(t,"color",3,"rgb(106, 191, 163)"),Q=c(t,"defaultOpacity",3,.5),L=c(t,"activeOpacity",3,.8),u=c(t,"border",3,1),w=c(t,"borderColor",3,"black"),f=c(t,"position",31,()=>q3([0,0])),d=c(t,"style",3,"background-color: rgb(215, 219, 221);"),h=c(t,"inputMapping",19,()=>({name:"Virtual Joystick",gamepad:-1,axes_x:0,axes_y:1,button_x_pos:[q.DPAD_RIGHT],button_x_neg:[q.DPAD_LEFT],button_y_pos:[q.DPAD_DOWN],button_y_neg:[q.DPAD_UP],deadzoneX:.05,deadzoneY:.05,key_x_pos:["d"],key_x_neg:["a"],key_y_pos:["s"],key_y_neg:["w"],invert_x:!1,invert_y:!1})),g=c(t,"context",19,()=>["default"]),l=c(t,"requiresFocus",3,!1);const r=s()/2;let v=!1,F,p,k=$(q3(Q()));function b(){return F}function x(T){if(e()||!h().gamepad||!v||!T.target)return;const O=T.target.getBoundingClientRect(),J=T.x-O.x,Y=T.y-O.y;p&&(p.gamepadActive=!1,m(J,Y))}function m(T,O){let J=T-i()/2,Y=O-o()/2;P(J,Y)}function P(T,O){const J=Z5(T,O),Y=$5(T,O);let O3=n4(J,r),I3=t4(O3,Y),l3=I3[0]/r,s3=I3[1]/r;if(Math.abs(l3)<h().deadzoneX&&Math.abs(s3)<h().deadzoneY){f([0,0]),S(k,Q());return}l3=Math.abs(l3)<1e-6?0:l3,s3=Math.abs(s3)<1e-6?0:s3,S(k,L()),f([l3,s3])}function A(){v=!1,S(k,Q()),f([0,0])}function W(T,O){S(k,T?L():Q(),!0),f(O)}u3(()=>(p=new it(h(),r,P,W,F,l()),E3(g(),p),()=>{p&&A3(g(),p)}));var I=Lt();m3("pointerup",t2,A),Q3(I,"tabindex",0),I.__keydown=()=>{F.focus()},I.__click=()=>{F.focus()};let K;I.__pointerdown=T=>{e()||(T.stopImmediatePropagation(),v=!0,x(T))},I.__pointerup=()=>{p?.activateGamepad()},I.__pointermove=x,I.__touchstart=[ot],I.__touchend=()=>{p?.activateGamepad()},I.__pointerout=()=>{p?.activateGamepad()};var a3=R(I);{var f3=T=>{var O=lt();let J;var Y=R(O),O3=R(Y);{var I3=_=>{z(_,{type:"generic",input:"axis_left"})},l3=_=>{var r3=r2(),F3=h3(r3);{var U2=B3=>{z(B3,{type:"generic",input:"axis_right"})};H(F3,B3=>{[2,3].includes(h().axes_x)&&[2,3].includes(h().axes_y)&&B3(U2)},!0)}D(_,r3)};H(O3,_=>{[0,1].includes(h().axes_x)&&[0,1].includes(h().axes_y)?_(I3):_(l3,!1)})}N(Y);var s3=M(Y,2),l2=R(s3);{var P2=_=>{z(_,{type:"keyboard_mouse",get input(){return h().key_y_neg[0]}})};H(l2,_=>{h().key_y_neg.length>0&&_(P2)})}var N2=M(l2,2);{var R2=_=>{z(_,{type:"generic",get input(){return h().button_y_neg[0]}})};H(N2,_=>{h().button_y_neg.length>0&&_(R2)})}N(s3);var H3=M(s3,2),L2=R(H3);{var q2=_=>{z(_,{type:"keyboard_mouse",get input(){return h().key_y_pos[0]}})};H(L2,_=>{h().key_y_pos.length>0&&_(q2)})}var D2=M(L2,2);{var S2=_=>{z(_,{type:"generic",get input(){return h().button_y_pos[0]}})};H(D2,_=>{h().button_y_pos.length>0&&_(S2)})}N(H3);var G3=M(H3,2),g2=R(G3);{var O2=_=>{var r3=rt(),F3=h3(r3);z(F3,{type:"keyboard_mouse",get input(){return h().key_x_neg[0]}}),d3(2),D(_,r3)};H(g2,_=>{h().key_x_neg.length>0&&_(O2)})}var H2=M(g2,2);{var G2=_=>{z(_,{type:"generic",get input(){return h().button_x_neg[0]}})};H(H2,_=>{h().button_x_neg.length>0&&_(G2)})}N(G3);var d2=M(G3,2),h2=R(d2);{var B2=_=>{var r3=at(),F3=h3(r3);z(F3,{type:"keyboard_mouse",get input(){return h().key_x_pos[0]}}),d3(2),D(_,r3)};H(h2,_=>{h().key_x_pos.length>0&&_(B2)})}var z2=M(h2,2);{var V2=_=>{z(_,{type:"generic",get input(){return h().button_x_pos[0]}})};H(z2,_=>{h().button_x_pos.length>0&&_(V2)})}N(d2),N(O),j(_=>J=U(O,"",J,_),[()=>({width:i()+"px",height:o()+"px"})]),y3(2,O,()=>b3),y3(1,O,()=>b3),D(T,O)};H(a3,T=>{E.showHints&&g().includes(E.context)&&T(f3)})}var o3=M(a3,2);let C3;var C=R(o3);let G;var e3=M(C,2);let X;return N(o3),N(I),w3(I,T=>F=T,()=>F),j((T,O,J,Y)=>{K=U(I,d(),K,T),C3=U(o3,"",C3,O),G=U(C,"",G,J),X=U(e3,"",X,Y)},[()=>({width:i()+"px",height:o()+"px"}),()=>({left:(i()-s())/2+"px",top:(o()-s())/2+"px"}),()=>({width:s()+"px",height:s()+"px",background:a(),opacity:y(k),transition:"none",border:u()>0?u()+"px solid "+w():0}),()=>({left:f()[0]*r+"px",top:f()[1]*r+"px","margin-top":r/2+"px","margin-left":r/2+"px",transition:"opacity 0.2s ease-in-out",width:r+"px",height:r+"px",background:a(),opacity:y(k),border:u()>0?u()+"px solid "+w():0})]),m3("pointerleave",I,()=>{p?.activateGamepad()}),D(n,I),n3({getElement:b})}i2(["keydown","click","pointerdown","pointerup","pointermove","touchstart","touchend","pointerout"]);var dt=V('<div id="sidenav" class="sidenav"><!> <!></div>');function ht(n,t){t3(t,!0);const e=["Main","Second","Third","Settings","Fifth"];let s;function i(){return s.getElement()}let o=c(t,"open",15,!1),a=$(0);function Q(){e[y(a)],o(!1)}var L=dt();let u;var w=R(L);{let d=g3(()=>({name:"close side nav",gamepad:-1,buttons:[q.LEFT],keys:["x"]}));R3(w,{cssclassWrapper:"closebtn",onpressed:()=>{o(!1)},get inputMapping(){return y(d)},children:(h,g)=>{d3();var l=N3("×");D(h,l)},$$slots:{default:!0}})}var f=M(w,2);{let d=g3(()=>!o());w3(T2(f,{get disabled(){return y(d)},onpressed:Q,get items(){return e},wrap:!0,get selectedIndex(){return y(a)},set selectedIndex(h){S(a,h,!0)}}),h=>s=h,()=>s)}return N(L),j(d=>u=U(L,"",u,d),[()=>({width:o()?"250px":"0"})]),D(n,L),n3({getListElement:i})}var Qt=V('<div class="help-modal svelte-zep3tj"><div class="help-content"><!> or <!> toggle help.</div></div>'),wt=V('<!> <!> <!> <!> <div class="background svelte-zep3tj"><main><!> <!> <!> <br/> <!> <br/>  <!><br/> <!><br/> <!> <!> <!><br/> <br/> <!></main></div>',1);function pt(n,t){t3(t,!0);const e=["banana","orange","apple","strawberry"];let s=$(0),i=$(q3([0,0])),o,a,Q=$(!0),L=$(!1),u=$(!0);const w={name:"Hint",gamepad:-1,buttons:[q.VIEW],keys:["h"]};u3(()=>{setTimeout(()=>{S(u,!1)},2e3)});var f=wt(),d=h3(f);j3(d,{context:["default","my_ctx"],onpressed:()=>{E.showHints=!E.showHints},get inputMapping(){return w}});var h=M(d,2);{let C=g3(()=>({name:"Focus next",gamepad:-1,buttons:[q.TRIGGER_RIGHT],keys:["k"]}));j3(h,{onpressed:()=>{a2()},get inputMapping(){return y(C)}})}var g=M(h,2);{let C=g3(()=>({name:"Focus previous",gamepad:-1,buttons:[q.TRIGGER_LEFT],keys:["i"]}));j3(g,{onpressed:()=>{e4()},get inputMapping(){return y(C)}})}var l=M(g,2);w3(ht(l,{get open(){return y(L)},set open(C){S(L,C,!0)}}),C=>a=C,()=>a);var r=M(l,2),v=R(r);let F;var p=R(v);{var k=C=>{var G=Qt();U(G,"",{},{"pointer-events":"none"});var e3=R(G),X=R(e3);z(X,{type:"keyboard_mouse",get input(){return w.keys[0]},color:"#FFFFFF"});var T=M(X,2);z(T,{type:"ps4",get input(){return w.buttons[0]},color:"#FFFFFF"}),d3(),N(e3),N(G),y3(3,G,()=>b3,()=>({duration:300})),D(C,G)};H(p,C=>{y(u)&&C(k)})}var b=M(p,2);{let C=g3(()=>({name:"Main Button",gamepad:-1,buttons:[q.RIGHT],keys:["e"]}));R3(b,{onrelease:()=>{o&&(o.changeContext("my_ctx"),S(Q,!1))},get inputMapping(){return y(C)},children:(G,e3)=>{d3();var X=N3("switch to context for button2!");D(G,X)},$$slots:{default:!0}})}var x=M(b,2);{let C=g3(()=>({name:"Second Button",gamepad:-1,buttons:[q.LEFT],keys:["q"]}));R3(x,{onrelease:()=>{o&&(o.changeContext("default"),S(Q,!0))},context:["my_ctx"],get inputMapping(){return y(C)},get disabled(){return y(Q)},children:(G,e3)=>{d3();var X=N3("switch back to default context!");D(G,X)},$$slots:{default:!0}})}var m=M(x,4);{let C=g3(()=>({name:"side nav",gamepad:-1,buttons:[q.UP],keys:["t"]}));R3(m,{onpressed:()=>{S(L,!0),a.getListElement().focus()},get inputMapping(){return y(C)},children:(G,e3)=>{d3();var X=N3("side nav");D(G,X)},$$slots:{default:!0}})}var P=M(m,4);J3(P,{});var A=M(P,3);J3(A,{});var W=M(A,3);J3(W,{});var I=M(W,2);T2(I,{get items(){return e},get selectedIndex(){return y(s)},set selectedIndex(C){S(s,C,!0)}});var K=M(I),a3=M(K);gt(a3,{get position(){return y(i)},set position(C){S(i,C,!0)}});var f3=M(a3,2),o3=M(f3,2),C3=M(o3);w3(s4(C3,{}),C=>o=C,()=>o),N(v),N(r),j((C,G,e3)=>{F=U(v,"",F,C),_3(K,` Selected: ${e[y(s)]??""} `),_3(f3,` x: ${G??""}`),_3(o3,` y: ${e3??""} `)},[()=>({"margin-left":y(L)?"250px":0}),()=>y(i)[0].toFixed(3),()=>y(i)[1].toFixed(3)]),D(n,f),n3()}export{pt as component};
